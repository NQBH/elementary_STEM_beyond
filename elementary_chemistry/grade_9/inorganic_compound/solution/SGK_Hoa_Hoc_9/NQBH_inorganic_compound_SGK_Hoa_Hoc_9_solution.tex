...
\begin{baitoan}[\cite{SGK_Hoa_Hoc_9}, 5., p. 21]
	Thực hiện các chuyển đổi hóa học sau bằng cách viết các {\rm PTHH} (ghi điều kiện của phản ứng, nếu có): (a) {\rm S $\to$ \ce{SO2} $\to$ \ce{SO3} $\to$ \ce{H2SO4}}. (b) {\rm\ce{SO2} $\to$ \ce{Na2SO3}}. (c) {\rm\ce{H2SO4} $\to$ \ce{SO2} $\to$ \ce{H2SO3} $\to$ \ce{Na2SO3} $\to$ \ce{SO2}}. (d) {\rm\ce{H2SO4} $\to$ \ce{Na2SO4} $\to$ \ce{BaSO4}}.
\end{baitoan}
...
\begin{baitoan}[\cite{SGK_Hoa_Hoc_9}, 2., p. 25]
	Có các base sau: {\rm\ce{Cu(OH)2,NaOH,Ba(OH)2}}. Cho biết các base nào: (a) tác dụng được với dung dịch {\rm HCl}. (b) bị nhiệt phân hủy. (c) tác dụng được với {\rm\ce{CO2}}. (d) đổi màu quỳ tím thành xanh. Viết {\rm PTHH}.
\end{baitoan}
