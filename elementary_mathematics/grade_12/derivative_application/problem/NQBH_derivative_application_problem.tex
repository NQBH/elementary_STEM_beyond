...
\section{Tangent Equation of Graphs of Functions -- Phương Trình Tiếp Tuyến của Đồ Thị Hàm Số}

\begin{baitoan}[\cite{TLCT_BT_dai_so_giai_tich_11}, 29., p. 58]
	(a) Khảo sát sự biến thiên của hàm số $f(x) = 2x^3 + 3x^2 + 1$. (b) Gọi $(C)$ là đồ thị của $f(x)$. Tìm các giao điểm của đường cong $(C)$ với parabol $(P):g(x) = 2x^2 + 1$. (c) Viết phương trình các tiếp tuyến của $(C),(P)$ tại 1 giao điểm của chúng. (d) Tìm các khoảng trên đó $(C)$ nằm phía trên hoặc phía dưới $(P)$.
\end{baitoan}

\begin{baitoan}[\cite{TLCT_BT_dai_so_giai_tich_11}, 30., p. 59]
	Cho parabol $(P):y = x^2 - 2x$. (a) Tìm tập hợp tất cả các điểm mà từ đó có thể kẻ đến $(P)$ đúng 1 tiếp tuyến. (b) Tìm tập hợp tất cả các điểm mà từ đó có thể kẻ đến $(P)$ 2 tiếp tuyến \& 2 tiếp tuyến đó vuông góc với nhau.
\end{baitoan}

\begin{baitoan}[\cite{TLCT_BT_dai_so_giai_tich_11}, 31., p. 59]
	(a) Chứng minh định lý: Đồ thị hàm số $y = f(x) = ax^3 + bx^2 + cx + d$ cắt trục hoành tại $3$ điểm phân biệt khi \& chỉ khi $f(x)$ có cực đại, cực tiểu \& $f(x_{\max})f(x_{\min}) < 0$. (b) Áp dụng định lý, chứng minh điều kiện cần \& đủ để phương trình $x^3 + px + q = 0$ có $3$ nghiệm phân biệt là $q^2 + \dfrac{4p^3}{27} < 0$.
\end{baitoan}

\begin{baitoan}[\cite{TLCT_BT_dai_so_giai_tich_11}, 32., p. 59]
	Cho hàm số $y = f(x) = \dfrac{x}{x^2 + 1}$ có đồ thị $(C)$. (a) Viết phương trình tiếp tuyến của đồ thị $(C)$ tại điểm có hoành độ $x = \frac{1}{3}$. (b) Chứng minh trong miền $x\ge-\frac{3}{4}$, tiếp tuyến này luôn nằm trên đồ thị $(C)$. (c) Từ đó suy ra: Nếu $x,y,z\in[-\frac{3}{4},\infty)$ có tổng bằng $1$ thì có bất đẳng thức $\dfrac{x}{x^2 + 1} + \dfrac{y}{y^2 + 1} + \dfrac{z}{z^2 + 1}\le\dfrac{9}{10}$.
\end{baitoan}

\begin{baitoan}[\cite{TLCT_BT_dai_so_giai_tich_11}, 33., p. 59]
	Chứng minh 3 đồ thị của 3 hàm số $f(x) = -x^2 + 3x + 6,g(x) = x^3 - x^2 + 4,h(x) = x^2 + 7x + 8$ tiếp xúc với nhau tại điểm $A(-1,2)$.
\end{baitoan}

\begin{baitoan}[\cite{TLCT_BT_dai_so_giai_tich_11}, 34., p. 59]
	Chứng minh các đồ thị của 2 hàm số $f(x) = \dfrac{x^2 + 3x}{2},g(x) = \dfrac{3x}{x + 2}$ tiếp xúc với nhau. Tìm tọa độ tiếp điểm của 2 đường cong này \& viết phương trình tiếp tuyến chung của chúng tại điểm đó.
\end{baitoan}

\begin{baitoan}[\cite{TLCT_BT_dai_so_giai_tich_11}, 35., p. 60]
	1 viên đạn được bắn ra với vận tốc ban đầu $v_0 > 0$ từ 1 nòng súng đặt ở gốc tọa độ $O$, nghiêng 1 góc $\alpha$ với mặt đất (nòng súng nằm trong mặt phẳng thẳng đứng $Oxy$ \& tạo với trục $Ox$ 1 góc $\alpha$). Biết quỹ đạo chuyển động của viên đạn là parabol $(\gamma_\alpha):y = -\dfrac{g}{2v_0^2}(1 + \tan^2\alpha)x^2 + x\tan\alpha$, với $g$: gia tốc trọng trường. Chứng minh $\forall\alpha\in(0,\frac{\pi}{2})$, $(\gamma_\alpha)$ luôn tiếp xúc với parabol $(\Gamma)$ có phương trình $y = -\dfrac{g}{2v_0^2}x^2 + \dfrac{v_0^2}{2g}$ \& tìm tọa độ tiếp điểm. $(\Gamma)$ được gọi là {\rm parabol an toàn}.
\end{baitoan}
