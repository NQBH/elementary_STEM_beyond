...
\begin{abstract}
	...
	Latest version:
	\begin{itemize}
		\item {\it Problem: Similar Triangles {\it\&} Similar Shapes -- Bài Tập: Tam Giác Đồng Dạng {\it\&} Hình Đồng Dạng}.
		
		PDF: {\sc url}: \url{.pdf}.
		
		\TeX: {\sc url}: \url{.tex}.
		\item {\it Problem \& Solution: Similar Triangles {\it\&} Similar Shapes -- Bài Tập \& Lời Giải: Tam Giác Đồng Dạng {\it\&} Hình Đồng Dạng}.
