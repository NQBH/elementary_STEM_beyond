...
\begin{baitoan}[\cite{Tuyen_Toan_9_old}, 177., pp. 67--68]
	Cho các đường thẳng $(d_1):2x - y = 2m - 1,(d_2):4x - 3y = 4m + 1$. (a) Chứng minh khi $m$ thay đổi, $(d_1),(d_2)$ luôn cắt nhau. Xác định tọa độ giao điểm $M$ theo $m$. (b) Chứng minh khi $m$ thay đổi thì $M$ luôn di động trên 1 đường thẳng cố định. (c) Tìm {\rm GTNN} của biểu thức $A = x^2 + y^2$ với $x,y$ thỏa mãn phương trình của $(d_1),(d_2)$.
\end{baitoan}
