...
\begin{abstract}
	...
	\begin{itemize}
		...
		PDF: {\sc url}: \url{https://github.com/NQBH/elementary_STEM_beyond/blob/main/elementary_mathematics/grade_9/2nd_order_function/problem/NQBH_2nd_order_function_problem.pdf}.
		
		\TeX: {\sc url}: \url{https://github.com/NQBH/elementary_STEM_beyond/blob/main/elementary_mathematics/grade_9/2nd_order_function/problem/NQBH_2nd_order_function_problem.tex}.
		...
		PDF: {\sc url}: \url{https://github.com/NQBH/elementary_STEM_beyond/blob/main/elementary_mathematics/grade_9/2nd_order_function/solution/NQBH_2nd_order_function_solution.pdf}.
		
		\TeX: {\sc url}: \url{https://github.com/NQBH/elementary_STEM_beyond/blob/main/elementary_mathematics/grade_9/2nd_order_function/solution/NQBH_2nd_order_function_solution.tex}.
	\end{itemize}
\end{abstract}
\tableofcontents
...
\begin{baitoan}[\cite{Tuyen_Toan_9_old}, 185., p. 71]
	(a) Cho hàm số $y = 3x^2$. Tìm {\rm GTNN, GTLN} của $y$ nếu $m\le x\le n$ với $m < 0 < n$. (b) Mở rộng với hàm số $y = ax^2$ \& $y = ax^2 + bx + c$.
\end{baitoan}
...
\begin{baitoan}[\cite{TLCT_THCS_Toan_9_dai_so}, 12.1., p. 69]
	(a) Trên parabol $(P):y = x^2$. Tính khoảng cách giữa 2 điểm A,B nằm trên parabol có hoành độ lần lượt bằng: $-1,2$ \& $a,b\in\mathbb{R}$. (b) Mở rộng cho $y = ax^2$ \& $y = ax^2 + bx + c$.
\end{baitoan}
...
\begin{baitoan}[\cite{TLCT_THCS_Toan_9_dai_so}, 12.3., p. 69]
	Trong mặt phẳng $(Oxy)$ cho đường thẳng $(d):y = kx + \dfrac{1}{2}$ \& parabol $(P):y = \dfrac{1}{2}x^2$. Giả sử đường thẳng $(d)$ cắt parabol $(P)$ tại 2 điểm phân biệt A,B. Chứng minh tọa độ trung điểm của đoạn thẳng AB thỏa mãn phương trình $y = x^2 + \dfrac{1}{2}$.
\end{baitoan}
...
\begin{baitoan}[\cite{Tuyen_Toan_9_old}, 205., p. 77]
	Cho 2 phương trình $x^2 + bx + c = 0,x^2 + cx + b = 0$ với $b,c\in\mathbb{R},\dfrac{1}{b} + \dfrac{1}{c} = \dfrac{1}{2}$. Chứng minh có ít nhất 1 trong 2 phương trình có nghiệm.
\end{baitoan}
...
\begin{baitoan}[\cite{Tuyen_Toan_9_old}, 208., p. 77]
	Tìm $m\in\mathbb{R}$ để 2 phương trình $x^2 + (2m - 1)x - 10 = 0,3x^2 + (4m - 3)x - 22 = 0$ có ít nhất 1 nghiệm chung.
\end{baitoan}
...
\begin{baitoan}[\cite{Thu_Viet_Minh_ptb2}, 4., p. 65]
	Tìm $m\in\mathbb{N}^\star$ để phương trình có nghiệm nguyên: (a) $x^2 - 2mx + m^2 + 2m - 7 = 0$. (b) $(m - 1)x^2 + 2(m + 1)x + m + 7 = 0$. (c) $mx^2 - 2mx + 3m - 2 = 0$. (d) $x^2 - 2mx + 2m + 10 = 0$.
\end{baitoan}
...
\begin{baitoan}[\cite{Thu_Viet_Minh_ptb2}, VD4, p. 78]
	Cho $a,b,c\in\mathbb{R}$ thỏa $3a + 5b + 15c = 0$. Chứng minh phương trình $ax^2 + bx + c = 0$ luôn có nghiệm.
\end{baitoan}
...
\fbox{1} Định lý Vi\`ete cho phép tính tổng \& tích 2 nghiệm của {\rm PTB2} mà không cần xác định các nghiệm của nó: $\Delta\ge0\Rightarrow ax^2 + bx + c = a(x - x_1)(x - x_2)$.
...
\begin{baitoan}[\cite{Tuyen_Toan_9_old}, 220., p. 82]
	Cho phương trình $x^2 + (4m + 1)x + 2(m - 4) = 0$. (a) Tìm $m\in\mathbb{R}$ để phương trình có 2 nghiệm $x_1,x_2$ thỏa $x_2 - x_1 = 17$. (b) Tìm $m\in\mathbb{R}$ để biểu thức $A = (x_1 - x_2)^2$ có {\rm GTNN}. (c) Tìm hệ thức liên hệ giữa 2 nghiệm không phụ thuộc vào $m$.
\end{baitoan}

\begin{baitoan}[\cite{Tuyen_Toan_9_old}, 221., p. 82]
	Cho phương trình $x^2 - px + q = 0$ với $p,q$ là 2 số nguyên tố. Biết phương trình có 2 nghiệm nguyên dương phân biệt, chứng minh $p^2 + q^2$ là 1 số nguyên tố.
\end{baitoan}
...
\begin{baitoan}[\cite{Thu_Viet_Minh_ptb2}, VD15, p. 99, HSG9 Bắc Ninh 2018]
	Cho phương trình $x^2 + (m^2 + 1)x + m - 2 = 0$. Tìm $m\in\mathbb{R}$ để phương trình có 2 nghiệm phân biệt $x_1,x_2$ thỏa $\dfrac{2x_1 - 1}{x_2} + \dfrac{2x_2 - 1}{x_1} = x_1x_2 + \dfrac{55}{x_1x_2}$.
\end{baitoan}
...
\begin{baitoan}[\cite{Thu_Viet_Minh_ptb2}, 3., p. 102]
	Cho phương trình $x^2 - 2(m + 1)x + m - 4 = 0$. (a) Chứng minh phương trình luôn có 2 nghiệm phân biệt $\forall m\in\mathbb{R}$. (b) Gọi 2 nghiệm của phương trình là $x_1,x_2$. Chứng minh giá trị của biểu thức $A= x_1(1 - x_2) + x_2(1 - x_1)$ không phụ thuộc vào m.
\end{baitoan}
...
\begin{baitoan}[\cite{Thu_Viet_Minh_ptb2}, 6., p. 119]
	Tìm $m\in\mathbb{R}$ để phương trình: (a) $x^3 - 2x^2 + (1 - m)x + m = 0$ có 3 nghiệm dương phân biệt. (b) $x^3 - (m + 1)x^2 + 2mx - m^2 = 0$ có 3 nghiệm phân biệt lớn hơn $-1$.
\end{baitoan}
...
\begin{baitoan}[\cite{Thu_Viet_Minh_ptb2}, 17., p. 137, TS10 chuyên Quảng Bình 2012--2013]
	Cho phương trình $x^2 - 2x + 4a = 0$. Giả sử 2 nghiệm $x_1,x_2$ của phương trình là số đo 2 cạnh góc vuông của 1 tam giác. (a) Tìm $a\in\mathbb{R}$ để diện tích của tam giác vuông bằng $\dfrac{1}{3}$. (b) Tìm {\rm GTNN} của biểu thức $A = x_1x_2 + \dfrac{4}{x_1x_2}$ khi $a > 0$.
\end{baitoan}
...
\begin{baitoan}[{\sf Program}: Giao điểm của các parabol \& các đường thẳng $\star$]
