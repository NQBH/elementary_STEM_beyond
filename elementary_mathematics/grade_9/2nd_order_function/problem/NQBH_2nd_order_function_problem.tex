...
\begin{baitoan}[{\sf Programming}: Solve quadratic equation]
	...
	\begin{itemize}
		...
		\item {\sf Output}: Số nghiệm của hệ phương trình: {\tt0}: vô nghiệm thực. {\tt1}: duy nhất 1 nghiệm thực kép, xuất ra nghiệm này với định dạng {\tt x = x0}. {\tt2}: 2 nghiệm thực phân biệt, xuất ra 2 nghiệm này với định dạng {\tt x1 = <root1>, x2 = <root2>}.
	\end{itemize}
\end{baitoan}
