...
\begin{proof}[2nd giải]
	Gọi điểm cho trước là $A$. $A\in(O,R)\Leftrightarrow OA = R$, nên tập hợp tâm các đường tròn bán kính $R$ đi qua $A$ là $\{O\in\mathbb{R}^2|OA = R\} = (A,R)$, suy ra có vô số đường tròn bán kính $R$ đi qua $A$.
\end{proof}
...
\begin{proof}[Giải]
	Gọi $M$ là trung điểm $AB$. Vẽ $(M,MA) = (M,\frac{1}{2}AB)$.
\end{proof}
