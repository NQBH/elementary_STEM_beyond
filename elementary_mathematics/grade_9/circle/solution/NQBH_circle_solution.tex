...
\title{Problem {\it\&} Solution: Circle -- Bài Tập{ \it\&} Lời Giải: Đường Tròn}
...
\fbox{1} $(O;R)\coloneqq\{M|OM = R\}$. \fbox{2} Tâm của đường tròn là \textit{tâm đối xứng} của đường tròn đó. Mọi đường thẳng đi qua tâm là \textit{trục đối xứng} (\& chứa 1 đường kính) của đường tròn. \fbox{3} Qua 3 điểm $A,B,C$ không thẳng hàng, xác định duy nhất 1 đường tròn. Tâm của đường tròn là giao của 3 đường trung trực 3 cạnh $\Delta ABC$. \fbox{4} $A\in(O;R)\Leftrightarrow OA = R$. $A$ nằm ngoài $(O;R)\Leftrightarrow OA > R$. $A$ nằm trong $(O;R)\Leftrightarrow OA < R$.  \fbox{5} Đường kính là dây lớn nhất. Cho $(O;R)$, đường kính $AB = 2R$, dây $CD < 2R$, $AB\cap CD = \{M\}$: $AB\bot CD\Leftrightarrow MC = MD\Leftrightarrow\Delta ACD$ cân $\Leftrightarrow AC = AD\Leftrightarrow\Delta BCD$ cân $\Leftrightarrow BC = BD$.
...
\begin{proof}[Giải]
	Vì bánh xe đạp có dạng đường tròn nên các nan hoa của nó dài bằng nhau \& cùng bằng bán kính đường tròn đó.
\end{proof}
...
\begin{proof}[1st giải]
	Có vô số đường tròn bán kính $R$ đi qua 1 điểm cho trước. Tâm các đường tròn này nằm trên đường tròn có tâm là điểm đã cho \& bán kính $R$.
\end{proof}

\begin{proof}[2nd giải]
	điểm cho trước là $A$. $A\in(O;R)\Leftrightarrow OA = R$, nên tập hợp tâm các đường tròn bán kính $R$ đi qua $A$ là $\{O\in\mathbb{R}^2|OA = R\} = (A;R)$, suy ra có vô số đường tròn bán kính $R$ đi qua $A$.
\end{proof}
...
\begin{proof}[Giải]
	Luôn tồn tại duy nhất 1 đường tròn đi qua 3 điểm không thẳng hàng bất kỳ (i.e., đường tròn ngoại tiếp tam giác tạo bởi 3 điểm đó) nhưng không tồn tại đường tròn nào đi qua 3 điểm phân biệt thẳng hàng bất kỳ.
\end{proof}
...
\begin{proof}[Giải]
	$M$ là trung điểm $AB$. Vẽ $(M,MA) = (M,\frac{1}{2}AB)$.
\end{proof}
...
\begin{proof}[Giải]
	Đường kính các đường tròn $(O;2R),(O;aR)$ lần lượt là $4R,2aR$, $\forall a\in\mathbb{R}$, $a > 0$.
\end{proof}
...
\begin{proof}[Giải]
	(a) Đ. (b) S. Với đường tròn $(O;R)$, đường kính $AB$, dây $CD$ khác đường kính, $AB\bot CD$. Khi đó $CD$ chia $AB$ thành 2 phần không bằng nhau. (c) S. Với đường tròn $(O;R)$, 2 đường kính $AB,CD$ không vuông góc nhau nhưng chúng vẫn đi qua trung điểm $O$ của nhau. (d) Đ.
\end{proof}
...
\begin{proof}[Giải]
	(a) Xét $\Delta ABC$ vuông tại $A$. $O$ là trung điểm $BC$. $AO$ là trung tuyến ứng với cạnh huyền $BC$ nên $OA = OB = OC$, suy ra $O$ là tâm đường tròn ngoại tiếp $\Delta ABC$. Vậy tâm đường tròn ngoại tiếp tam giác vuông là trung điểm cạnh huyền. (b) Xét $\Delta ABC$ nội tiếp $(O;R)$ đường kính $BC = 2R$. Có $OA = OB = OC = R$. Vì $AO$ là trung tuyến ứng với cạnh $BC$, $AO = \frac{1}{2}BC$ nên $\Delta ABC$ vuông tại $A$. (c) Xét $\Delta ABC$ vuông tại $A$, $M$ là trung điểm $BC$. Từ (a), $(M,\frac{1}{2}BC)$ là đường tròn ngoại tiếp $\Delta ABC$, nên $A\in(M,\frac{1}{2}BC)$, suy ra $\{A\in\mathbb{R}^2|\Delta ABC\mbox{ vuông tại } A\}\subset(M,\frac{1}{2}BC)$, i.e., các đỉnh góc vuông của các tam giác vuông có chung cạnh huyền cùng thuộc 1 đường tròn đường kính là cạnh huyền chung đó. (d) Xét hình chữ nhật $ABCD$ có $O$ là giao điểm 2 đường chéo $AC,BD$. Vì mọi hình chữ nhật có 2 đường chéo bằng nhau \& cắt nhau tại trung điểm mỗi đường nên $OA = OB = OC = OD = \frac{1}{2}AC = \frac{1}{2}BD$, suy ra $ABCD$ nội tiếp đường tròn $(O,\frac{1}{2}AC)$, i.e., mọi hình chữ nhật đều nội tiếp được trong đường tròn có tâm là giao điểm 2 đường chéo (trung điểm của chúng) \& đường kính là độ dài đường chéo của hình chữ nhật đó.
\end{proof}

\begin{baitoan}[\cite{Binh_boi_duong_Toan_9_tap_1}, VD2, p. 102]
	Khi nào thì tâm của đường tròn ngoại tiếp tam giác nằm: (a) Trong tam giác? (b) Trên cạnh tam giác? (c) Ngoài tam giác?
\end{baitoan}

\begin{proof}[Giải]
	(a) Giả sử tồn tại điểm $O$ nằm trong $\Delta ABC$ sao cho $OA = OB = OC$. $\Delta OAB,\Delta OBC,\Delta OCA$ cân tại $O$ nên $\angle{BAO} = \frac{1}{2}(180^\circ - \angle{AOB})$, $\angle{CAO} = \frac{1}{2}(180^\circ - \angle{AOC})$, nên $\angle{A} = \angle{BAO} + \angle{CAO} = \frac{1}{2}(360^\circ - \angle{AOB} - \angle{AOC}) = \frac{1}{2}\angle{BOC} < \frac{1}{2}\cdot180^\circ = 90^\circ$ vì $\angle{BOC}$ là góc trong $\Delta BOC$ nên $\angle{BOC} < 180^\circ$. Tương tự, ta thu được $\angle{B} < 90^\circ,\angle{C} < 90^\circ$ nên $\Delta ABC$ nhọn. Vậy tâm của đường tròn ngoại tiếp tam giác nằm trong tam giác khi tam giác đó nhọn.
\end{proof}

\begin{dinhly}
	Cho $\Delta ABC$ nội tiếp đường tròn $(O)$. (a) O nằm trong $\Delta ABC\Leftrightarrow\Delta ABC$ nhọn. (b) O nằm trên cạnh $\Delta ABC\Leftrightarrow\Delta ABC$ vuông. (c) O nằm ngoài $\Delta ABC\Leftrightarrow\Delta ABC$ tù.
\end{dinhly}
...
\begin{proof}[Giải]
	Có $AC^2 + BC^2 = 5^2 + 12^2 = 169 = 13^2 = AB^2$, áp dụng định lý Pythagore đảo, suy ra $\Delta ABC$ vuông tại $C$, nên tâm đường tròn ngoại tiếp $\Delta ABC$ là trung điểm $O$ của cạnh $AB$, bán kính $R = \frac{1}{2}AB = \frac{13}{2} = 6.5$ cm.
\end{proof}
...
\begin{proof}[Giải]
	Vì mọi đường thẳng đi qua tâm của 1 đường tròn đều là trục đối xứng của đường tròn đó, nên đường thẳng đi qua tâm của 2 hình tròn chính là trục đối xứng của miếng bìa. Cắt theo trục đối xứng đó sẽ chia đôi miếng bìa đó. Cụ thể, cho đường tròn $(O_2)$ nằm trong đường tròn $(O_1)$, cắt theo đường thẳng $O_1O_2$ nối tâm 2 đường tròn $(O_1),(O_2)$.
\end{proof}
...
\begin{proof}[Giải]
	Gọi $C,D$ lần lượt là trung điểm $AB,BM$. $AB$ là trục đối xứng của $(C,AC),(D,BD)$. Vì $E,F\in(C,AC)$, $EF\bot AB$ nên $NE = NF$ (1). Vì $P,Q\in(D,BD)$, $PQ\in(D,BD)$ nên $NP = NQ$ (2). Từ (1) \& (2) có $EP = NE - NP = NF - NQ = FQ$. (b) $\Delta ABE$ nội tiếp $(C,AC$) có $AB$ là đường kính nên $\Delta ABE$ vuông tại $E$, suy ra $\angle{BAE} = 90^\circ - \angle{ABE}$ (3). $\Delta BMP$ nội tiếp $(D,BD)$ có $BM$ là đường kính nên $\Delta BMP$ vuông tại $P$, suy ra $\angle{BMP} = 90^\circ - \angle{MBP}$ (4). Trong $\Delta BEN$, $P$ nằm giữa $N,E$ nên $\angle{EBM} > \angle{PBM}$ (5). Từ (3)--(5) suy ra $\angle{BMP} > \angle{BAE}$.	
\end{proof}
...
\begin{proof}[Giải]
	Giả sử dựng được cát tuyến $ABC$ thỏa $AB BC$. Gọi $E$ là trung điểm $BC$ thì $OE\bot BC$. Từ $B$ kẻ $BP\parallel EO$, $P\in AO$, suy ra $BP\bot AB$. 
\end{proof}
...
\begin{proof}[Giải]
	Giả sử đường thẳng $OA$ cắt $(O;R)$ tại $N,P$, $P$ nằm giữa $O,A$. $\forall M\in(O;R)$, áp dụng bất đẳng thức tam giác: $MO + MA\ge OA\Leftrightarrow MA\ge OA - R = PA$. ``$=$'' xảy ra $\Leftrightarrow M\equiv P$. Mặt khác, $|MA - MO|\le OA\Leftrightarrow MA\le OA + OM = OA + R = AN$. ``$=$'' xảy ra $\Leftrightarrow M\equiv N$. Vậy $MA$ $\min\Leftrightarrow M\equiv P$, $MA$ $\max\Leftrightarrow M\equiv N$.
\end{proof}

\begin{nhanxet}
	Kết quả cũng tương tự với điểm A nằm trong đường tròn.
\end{nhanxet}
...
\begin{proof}[Chứng minh]
	Gọi $H,K$ lần lượt là trung điểm $AB,CD$, có $OH\bot AB,OK\bot CD$. Áp dụng định lý Pythagore: $AB^2 + CD^2 = 4AH^2 + 4CK^2 = 4(OA^2 - OH^2 + OC^2 - OK^2) = 4[R^2 + R^2 - (OH^2 + OK^2)] = 8R^2 - 4HK^2 = 8R^2 - 4OP^2 =$ const. $OP = HK$ vì tứ giác $OHPK$ có 3 góc vuông ($AB\cdot CD\Rightarrow\angle HPK = 90^\circ$) nên là hình chữ nhật.
\end{proof}
...
\begin{proof}[Chứng minh]
	Vì $AB$ là đường kính đường tròn $(O;R)$ nên $\angle C = \angle D = 90^\circ$. Hạ $EH\bot AB$. $\Delta ACB\backsim\Delta AHE$ (2 tam giác vuông, $\angle BAC$ chung) $\Rightarrow\dfrac{AC}{AB} = \dfrac{AH}{AE}\Leftrightarrow AE\cdot AC = AH\cdot AB$ (1). Tương tự, $\Delta BDA\backsim\Delta BHE$ (2 tam giác vuông, $\angle ABD$ chung) $\Rightarrow\dfrac{BD}{AB} = \dfrac{BH}{BE}\Leftrightarrow BE\cdot BD = BH\cdot AB$ (2). Cộng (1) \& (2), vế theo vế: $AE\cdot AC + BE\cdot BD = AH\cdot AB + BH\cdot AB = AB(AH + BH) = AB^2 = 4R^2$.
\end{proof}
...
\begin{proof}[Chứng minh]
	Giả sử $O$ là điểm bất kỳ trong tứ giác $ABCD$, tạo thành 4 góc $\angle{AOB},\angle BOC,\angle COD,\angle DOA$, có $\angle{AOB} + \angle BOC + \angle COD + \angle DOA = 360^\circ$ nên ít nhất 1 trong 4 góc đó $\ge90^\circ$. Không mất tính tổng quát, giả sử $\angle COD\ge90^\circ$, khi đó $O$ nằm trong hoặc trên đường tròn đường kính $CD$.
\end{proof}
...
\begin{proof}[Giải]
	Vẽ 2 tia $AM,BM$ lần lượt cắt nửa đường tròn đường kính $AB$ tại $E,F$. Vẽ 2 tia $AF,BE$, chúng cắt nhau tại $C$. Nối $CM$, có $CM\bot AB$. Thật vậy, $\Delta ABE,\Delta ABF$ nội tiếp đường tròn đường kính $AB$ nên chúng lần lượt vuông tại $E,F$, suy ra $M$ là trực tâm $\Delta ABC$, suy ra $CM\bot AB$.
\end{proof}
...
\begin{proof}[Giải]
	(a) $AM = 2AC$. $AM\ \max\Leftrightarrow AC\ \max\Leftrightarrow AC$ là đường kính của $(O;R)\Leftrightarrow C\equiv B$. (b) Điểm $C$ nằm trên đường tròn đường kính $AB\Leftrightarrow\angle ACB = 90^\circ$. Xét $\Delta ABC$ vuông tại $A$: $AC = AB\cos A = 2R\cos A\Leftrightarrow AM = 2AC = 4R\cos A$. $AM = 2R\sqrt{3}\Leftrightarrow4R\cos A = 2R\sqrt{3}\Leftrightarrow\cos A = \frac{\sqrt{3}}{2}\Leftrightarrow\angle A = 30^\circ$. (c) $\Delta ABM$ có $BC$ vừa là đường cao vừa là đường trung tuyến nên cân tại $B$, suy ra $BM = AB = 2R\Rightarrow M\in(B,2R)$ cố định.
\end{proof}

\begin{nhanxet}
	``Phương pháp chung để chứng minh 1 điểm thuộc 1 đường tròn cố định là chứng minh điểm đó cách 1 điểm cố định 1 khoảng không đổi. Còn muốn chứng minh nhiều điểm cùng thuộc 1 đường tròn, ta chứng minh các điểm này cùng cách đều 1 điểm.'' -- {\rm\cite[p. 114]{Tuyen_Toan_9_old}}
\end{nhanxet}

\begin{nhanxet}
	Mở rộng (b): Xác định vị trí của điểm $C$ để $AM = aR$. Tương tự, $AM = aR\Leftrightarrow4R\cos A = aR\Leftrightarrow\cos A = \frac{a}{4}$. Nếu $a\in[0,4]$ thì $\angle A = \arccos\frac{a}{4}$. Nếu $a\in(-\infty,0)\cup(4,\infty)$ thì phương trình $\cos A = \frac{a}{4}$ vô nghiệm nên không tồn tại điểm M thỏa mãn.
\end{nhanxet}

\begin{baitoan}[\cite{Tuyen_Toan_9_old}, 36., p. 114]
	Cho $\Delta ABC$ cân tại $A$, đường cao $AH$. Tính bán kính đường tròn ngoại tiếp $\Delta ABC$ khi: (a) $AH = BC = a$. (b) $AH = h$, $BC = a$.
\end{baitoan}

\begin{proof}[Giải]
	(a) Kéo dài $AH$ cắt đường tròn $(ABC)$ tại $D$. Vì $\Delta ABC$ cân tại $A$ nên $AD$ là đường kính $(ABC)$, suy ra $\angle ABD = 90^\circ\Rightarrow BH^2 = AH\cdot DH\Leftrightarrow\left(\frac{a}{2}\right)^2 = a(2R - a)\Leftrightarrow R = \frac{5}{8}a$. (b) Tương tự, $BH^2 = AH\cdot DH\Leftrightarrow\left(\frac{a}{2}\right)^2 = h(2R - h)\Leftrightarrow R = \frac{a^2}{8h} + \frac{h}{2}$.
\end{proof}

\begin{baitoan}[\cite{Tuyen_Toan_9_old}, 37., p. 114]
	Cho $\Delta ABC$. $D,E,F$ lần lượt là trung điểm $BC,CA,AB$. Chứng minh: 3 đường tròn $(AFE),(BFD)$, $(CDE)$ bằng nhau \& cùng đi qua 1 điểm. Xác định điểm chung đó.
\end{baitoan}

\begin{proof}[Chứng minh]
	Gọi $O$ là tâm đường tròn ngoại tiếp $\Delta ABC$. $\Delta AEO,\Delta AFO$ là 2 tam giác vuông chung cạnh huyền $OA$ nên $E,F$ nằm trên đường tròn đường kính $OA$, suy ra $O\in(AEF)$. Chứng minh tương tự, $O\in(BDF),O\in(CDE)$. Vì $D,E,F$ lần lượt là trung điểm của 3 cạnh $\Delta ABC$ nên $\Delta AFE = \Delta FBD = \Delta EDC$ (c.c.c), suy ra 3 đường tròn $(AEF),(BDF),(CDE)$ bằng nhau \& cùng đi qua tâm $O$ đường tròn ngoại tiếp $\Delta ABC$.
\end{proof}

\begin{baitoan}[\cite{Tuyen_Toan_9_old}, 38., p. 114]
	Cho hình thoi $ABCD$ cạnh $a$, 2 đường chéo cắt nhau tại $O$. $R_1$ \& $R_2$ lần lượt là bán kính các đường tròn ngoại tiếp các $\Delta ABC,\Delta ABD$. Chứng minh: $\dfrac{1}{R_1^2} + \dfrac{1}{R_2^2} = \dfrac{4}{a^2}$.
\end{baitoan}

\begin{proof}[Chứng minh]
	Gọi $M$ là trung điểm $AB$. Vẽ đường trung trực của $AB$ cắt $AC$ tại $K$, cắt $BD$ tại $I$. $I,K$ lần lượt là tâm đường tròn ngoại tiếp $\Delta ABC,\Delta ABD$ nên $IB = R_1,AK = R_2$. $\Delta MBI\backsim\Delta OBA$ (g.g) $\Rightarrow\dfrac{BI}{AB} = \dfrac{BM}{BO}\Leftrightarrow\dfrac{R_1}{a} = \dfrac{a}{2OB}\Leftrightarrow\dfrac{1}{R_1} = \dfrac{2OB}{a^2}\Leftrightarrow\dfrac{1}{R_1^2} = \dfrac{4OB^2}{a^4}$ (1). $\Delta MAK\backsim\Delta OAB$ (g.g) $\Rightarrow\dfrac{AK}{AB} = \dfrac{AM}{OA}\Leftrightarrow\dfrac{R_2}{a} = \dfrac{a}{2OA}\Leftrightarrow\dfrac{1}{R_2} = \dfrac{2OA}{a^2}\Leftrightarrow\dfrac{1}{R_1^2} = \dfrac{4OA^2}{a^4}$ (2). Áp dụng định lý Pythagore cho $\Delta OAB$ vuông tại $O$: $OA^2 + OB^2 = AB^2$. Cộng (1) \& (2), vế theo vế, rồi áp dụng (3): $\dfrac{1}{R_1^2} + \dfrac{1}{R_2^2} = \dfrac{4(OA^2 + OB^2)}{a^4} = \dfrac{4AB^2}{a^4} = \dfrac{4a^2}{a^4} = \dfrac{4}{a^2}$.
\end{proof}

\begin{baitoan}[\cite{Tuyen_Toan_9_old}, 39., p. 115]
	Cho hình bình hành $ABCD$, cạnh $AB$ cố định, đường chéo $AC = a$ \emph{cm} với $a > 0$. Chứng minh điểm $D$ di động trên 1 đường tròn cố định.
\end{baitoan}

\begin{proof}[Chứng minh]
	Vẽ điểm $O$ đối xứng với $B$ qua $A$, suy ra $O$ cố định. Tứ giác $OACD$ có $OA\parallel CD$ \& $OA = AB = CD = a$ cm nên $OACD$ là hình bình hành, suy ra $OD = AC = a$ cm $\Rightarrow D\in(O,a\ {\rm cm})$.
\end{proof}
...
\begin{proof}[Chứng minh]
	Gọi $M$ là trung điểm $BC$. Trên $OM$ lấy $K$ thỏa $MK = \frac{1}{3}MO$, $K$ cố định. Vì $G$ là trọng tâm $\Delta ABC$ nên $MG = \frac{1}{3}AM$. $\Delta MKG\backsim\Delta MOA$ (c.g.c) $\Rightarrow\dfrac{KG}{OA} = \dfrac{MK}{MO} = \dfrac{1}{3}\Rightarrow KG = \dfrac{OA}{3} = \dfrac{R}{3}\Rightarrow G\in(K;\frac{1}{3})$ cố định.
\end{proof}
...
\begin{proof}[Chứng minh]
	Gọi $A$ là 1 điểm trong số $2n + 1$ điểm đã cho. Vẽ đường tròn $(A;1)$. Nếu tất cả $2n$ điểm còn lại đều nằm trong đường tròn $(A;1)$ thì kết luận bài toán đúng. Nếu $B$ là 1 điểm không nằm trong đường tròn $(A;1)$ thì $AB\ge1$. Vẽ đường tròn $(B;1)$. Gọi $C$ là 1 điểm trong số $2n - 1$ điểm còn lại (ngoại trừ $A,B$). Trong 3 điểm $A,B,C$ có 2 điểm có khoảng cách nhỏ hơn $1$. Vì $AB\ge1$ nên $AC < 1$ hoặc $BC < 1$, i.e., $C$ nằm trong $(A;1)$ hoặc $C$ nằm trong $(B;1)$. Nên 2 đường tròn $(A;1),(B;1)$ chứa tất cả $2n + 1$ điểm đã cho. Theo nguyên lý Dirichlet phải có 1 trong 2 đường tròn chứa ít nhất $n + 1$ điểm.
\end{proof}
...
\begin{proof}[Chứng minh]
	Gọi $M,N$ lần lượt là trung điểm của 2 cạnh đáy $AB,CD$ của hình thang cân $ABCD$. $MN$ là trục đối xứng của hình thang cân $ABCD$ nên $MN$ là đường trung trực của $AB,CD$. Gọi $O$ là giao điểm của $MN$ với đường trung trực của $BC$. $O$ thuộc đường trung trực của $AB\Leftrightarrow OA = OB$. $O$ thuộc đường trung trực của $BC\Leftrightarrow OB = OC$. $O$ thuộc đường trung trực của $CD\Leftrightarrow OC = OD$. Kết hợp lại, suy ra $OA = OB = OC = OD$, i.e., $A,B,C,D\in(O;OA)$.
\end{proof}

\begin{luuy}
	1 hình thang cân bất kỳ luôn nội tiếp 1 đường tròn với tâm là giao điểm 4 đường trung trực của 4 cạnh hình thang cân đó. Hơn nữa, nếu 1 hình thang nội tiếp được 1 đường tròn thì hình thang đó cân.
\end{luuy}

\begin{baitoan}[\cite{Binh_Toan_9_tap_1}, 50., p. 95]
	(a) Cho $\Delta ABC$ cân tại A nội tiếp đường tròn $(O)$, $AC = 40$ {\rm cm}, $BC = 48$ {\rm cm}. Tính khoảng cách từ O đến BC. (b) Mở rộng cho $AC = b,BC = a$, $\forall a,b\in\mathbb{R}$, $0 < a < 2b$.
\end{baitoan}

\begin{proof}[Giải]
	(a) Kẻ đường cao $AH$, $H\in BC$. $\Delta ABC$ cân tại $A$ nên $AH$ cũng là đường trung tuyến, suy ra $BH = CH = \frac{1}{2}BC = \frac{48}{2} = 24$. Áp dụng định lý Pythagore cho $\Delta AHC$ vuông tại $H$: $AH = \sqrt{AC^2 - CH^2} = \sqrt{40^2 - 24^2} = 32$. Vì $AH > CH$ nên tâm $O$ nằm giữa $A,H$. Đặt $x\coloneqq OH$. Kẻ $OM\bot AC$, $M\in AC$, suy ra $M$ là trung điểm $AC$, nên $MA = MC = \frac{1}{2}AC = \frac{40}{2} = 20$. $\Delta AMO\backsim\Delta AHC$ (g.g) $\Rightarrow\dfrac{AO}{AC} = \dfrac{AM}{AH}\Leftrightarrow\dfrac{32 - x}{40} = \dfrac{20}{32}\Leftrightarrow x = 7$ cm. (b) Tương tự, $BH = CH = \frac{1}{2}BC = \frac{a}{2}$. Áp dụng định lý Pythagore cho $\Delta AHC$ vuông tại $H$: $AH = \sqrt{AC^2 - CH^2} = \sqrt{b^2 - \left(\frac{a}{2}\right)^2} = \sqrt{b^2 - \frac{a^2}{4}}$. Xét 3 trường hợp: (i) $AH = CH\Leftrightarrow\sqrt{b^2 - \frac{a^2}{4}} = \frac{a}{2}\Leftrightarrow b^2 - \frac{a^2}{4} = \frac{a^2}{4}\Leftrightarrow b^2 = \frac{a^2}{2}\Leftrightarrow a = b\sqrt{2}$ thì $\Delta AHC$ vuông cân, $O\equiv H$ nên $d(O,BC) = 0$. (ii) $AH > CH\Leftrightarrow\sqrt{b^2 - \frac{a^2}{4}} > \frac{a}{2}\Leftrightarrow b^2 - \frac{a^2}{4} > \frac{a^2}{4}\Leftrightarrow b^2 > \frac{a^2}{2}\Leftrightarrow a < b\sqrt{2}$ thì $O$ nằm giữa $A,H$. Kẻ $OM\bot AC$, $M\in AC$, suy ra $M$ là trung điểm $AC$, nên $MA = MC = \frac{1}{2}AC = \frac{b}{2}$. $\Delta AMO\backsim\Delta AHC$ (g.g)
	\begin{align*}
		\Rightarrow\dfrac{AO}{AC} = \dfrac{AM}{AH}\Leftrightarrow\dfrac{\sqrt{b^2 - \frac{a^2}{4}} - x}{b} = \dfrac{\frac{b}{2}}{\sqrt{b^2 - \frac{a^2}{4}}}\Leftrightarrow\sqrt{b^2 - \frac{a^2}{4}} - x = \frac{b^2}{2\sqrt{b^2 - \frac{a^2}{4}}}\Leftrightarrow x = \sqrt{b^2 - \frac{a^2}{4}} - \frac{b^2}{2\sqrt{b^2 - \frac{a^2}{4}}} = \frac{2b^2 - a^2}{2\sqrt{4b^2 - a^2}}.
	\end{align*}
	(iii) $AH < CH\Leftrightarrow\sqrt{b^2 - \frac{a^2}{4}} < \frac{a}{2}\Leftrightarrow b^2 - \frac{a^2}{4} < \frac{a^2}{4}\Leftrightarrow b^2 < \frac{a^2}{2}\Leftrightarrow a > b\sqrt{2}$ thì $H$ nằm giữa $A,O$. Kẻ $OM\bot AC$, $M\in AC$, $OM$ cắt $CH$ tại $D$, suy ra $M$ là trung điểm $AC$, nên $MA = MC = \frac{1}{2}AC = \frac{b}{2}$. $\Delta AMO\backsim\Delta AHC$ (g.g)
	\begin{align*}
		***
	\end{align*}	
\end{proof}
...
\begin{proof}[Giải]
	Kẻ đường kính $AD$ của đường tròn $(O)$ thì $\angle ABD = 90^\circ$. Áp dụng hệ thức lượng cho $\Delta ABD$ vuông tại $B$: $AB^2 = AH\cdot AD\Leftrightarrow2R = AD = \dfrac{AB^2}{AH} = \dfrac{b^2}{h}\Leftrightarrow R = \dfrac{b^2}{2h}$.
\end{proof}
...
Cho $(O;R)$, 2 dây $AB,CD$. $H,K$ lần lượt là hình chiếu của $O$ lên $AB,CD$. $OH\bot AB,OK\bot CD\Rightarrow H,K$ lần lượt là trung điểm của $AB,CD$. \fbox{1} $AB = CD\Leftrightarrow OH = OK\Leftrightarrow d(O,AB) = d(O,CD)$ với $d(A,d_0)$ là \textit{khoảng cách} (distance) từ điểm $A$ tới đường thẳng $d_0$. \fbox{2} $AB > CD\Leftrightarrow OH < OK\Leftrightarrow d(O,AB) < d(O,CD)$. \fbox{3} {\sf Công thức liên hệ giữa độ dài dây \& khoảng cách từ tâm đường tròn đến dây đó.} $AB = 2AH = 2\sqrt{R^2 - OH^2} = 2\sqrt{R^2 - d(O,AB)^2}\le2\sqrt{R^2} = 2R$. ``$=$'' xảy ra $\Leftrightarrow d(O,AB) = 0\Leftrightarrow O\in AB\Leftrightarrow AB$ là đường kính $(O;R)$. \fbox{4} $AB = 2R\Leftrightarrow OH = 0\Leftrightarrow d(O,AB) = 0\Leftrightarrow O\in AB\Leftrightarrow AB$ là đường kính đường tròn $(O;R)$.
...
\begin{proof}[1st giải]
	Dây càng lớn thì khoảng cách từ tâm đến dây càng nhỏ \& ngược lại.
\end{proof}

\begin{proof}[2nd giải]
	Đường kính là dây lớn nhất trong đường tròn vì khoảng cách từ tâm đến đường kính bằng $0$ (i.e., khoảng cách nhỏ nhất có thể trong các khoảng cách từ tâm đường tròn đến các dây của đường tròn đó).
\end{proof}

\begin{proof}[3rd giải]
	Cho đường tròn $(O;R)$, dây $AB$ bất kỳ, có $AB = 2\sqrt{R^2 - d(O,AB)^2}\le2\sqrt{R^2} = 2R$. ``$=$'' xảy ra $\Leftrightarrow d(O,AB) = 0\Leftrightarrow O\in AB\Leftrightarrow AB$ là đường kính $(O;R)$.
\end{proof}
...
\begin{proof}[Giải]
	$AB\bot OM\Leftrightarrow M$ là trung điểm $AB$. Gọi $K$ là trung điểm $CD$ thì $OK\bot CD$. (a) $\Delta OKM$ vuông tại $K$ có cạnh huyền $OM$ nên $OM > OK$. Trong 2 dây $AB,CD$, dây $CD$ gần $O$ hơn nên lớn hơn: $AB > CD$. (b) 2 góc nhọn $\angle KDO,\angle MBO$ (nhọn vì $\Delta OKD,\Delta OBM$ vuông) có $\sin\angle KDO = \dfrac{OK}{OD} = \dfrac{OK}{R}$, $\sin\angle MBO = \dfrac{OM}{OB} = \dfrac{OM}{R}$. Có $OM > OK\Leftrightarrow\sin\angle KDO < \sin\angle MBO\Leftrightarrow\angle ODM < \angle OBM$. (c) Theo (a), trong các dây thay đổi luôn đi qua $M$, dây $AB\bot OM$ có độ dài nhỏ nhất. Dây đi qua $M,O$ là đường kính nên có độ dài lớn nhất.
\end{proof}
...
\begin{proof}[Chứng minh]
	Chỉ cần xét trường hợp $AM,AF$ cùng là 2 đoạn ngắn hơn hoặc dài hơn trong 2 cặp đoạn thẳng $(AM,AN)$, $(AE,AF)$, cần chứng minh $EM = FN$ (trường hợp $AM,AE$ cùng là 2 đoạn ngắn hơn hoặc dài hơn trong 2 cặp đoạn thẳng $(AM,AN)$, $(AE,AF)$, chứng minh $EN = FM$ tương tự). Gọi $I,K$ lần lượt là trung điểm $EF,MN$ thì $OI\bot EF,OK\bot MN$. Vì $MN = EF$ (gt) nên $OI = OK,IF = \frac{1}{2}EF = \frac{1}{2}MN = KM$, nên $\Delta OIF = \Delta OKM$ (ch.cgn) $\Rightarrow\angle OMK = \angle OFI$ (1). $\Delta FOM$ cân tại $O$ ($OF = OM = R$) $\Rightarrow\angle OMF = \angle OFM$ (2). Từ (1), (2) suy ra $\angle EFM = \angle NMF$ (3). Có $\Delta MFE = \Delta FMN$ vì $MN = EF$, $MF$ chung, \& (3) (c.g.c) $\Rightarrow EM = FN$. 
\end{proof}
...
\begin{proof}[Chứng minh]
	(a) Gọi $I$ là trung điểm $MN$ (1) thì $OI\bot MN$. $CM\parallel DN\Rightarrow$ tứ giác $CDNM$ là hình thang. $OC = OA - AC = R - AC = R - BD = OD - BD = OD$ (2). Từ (1) \& (2) suy ra $OI$ là đường trung bình của hình thang $CDNM$, nên $OI\parallel CM\parallel DN$, mà $OI\bot MN$, nên $CM\bot MN,DN\bot MN$, i.e., $CDNM$ là hình thang vuông tại $M,N$. (b) Vì $OI$ là đường trung bình của hình thang $CDNM$ nên $CM + DN = 2OI$, nên $CM + DN$ nhỏ nhất $\Leftrightarrow OI$ nhỏ nhất $\Leftrightarrow MN$ lớn nhất. Trong hình thang vuông $CDNM$, $MN\le CD$ (đường xiên không nhỏ hơn khoảng cách giữa 2 đường song song), nên $MN$ lớn nhất $\Leftrightarrow MN = CD\Leftrightarrow CDNM$ là hình chữ nhật. Vậy khi $CM\bot AB,DN\bot AB$ thì $CM + DN$ nhỏ nhất.
\end{proof}
...
\begin{proof}[1st chứng minh]
	$H,E$ lần lượt là trung điểm $AB,CD\Rightarrow OH\bot AB,OE\bot CD$. Áp dụng định lý Pythagore cho $\Delta OHM,\Delta OEM$ lần lượt vuông tại $H,E$: $OH^2 + HM^2 = OM^2 = OE^2 + EM^2$ nên $AB < CD\Leftrightarrow OH > OE\Leftrightarrow OH^2 > OE^2\Leftrightarrow OM^2 - OH^2 < OM^2 - OE^2\Leftrightarrow HM^2 < EM^2\Leftrightarrow HM < EM$.
\end{proof}

\begin{proof}[2nd chứng minh]
	$H,E$ lần lượt là trung điểm $AB,CD\Rightarrow OH\bot AB,OE\bot CD$. Vẽ đường tròn tâm $I$ đường kính $OM$. $\angle OHM = \angle OEM = 90^\circ\Leftrightarrow H,E\in(I,IM)$. Kẻ $IK\bot MH,IG\bot ME$ thì $K,G$ lần lượt là trung điểm $HM,EM$, mà $I$ là trung điểm $MO$ nên $IK,IG$ lần lượt là đường trung bình của $\Delta OHM,\Delta OEM$, suy ra $OH = 2IK,OE = 2IG$. $AB < CD\Leftrightarrow OH > OE\Leftrightarrow IK > IG\Leftrightarrow MH < ME$.
\end{proof}

\begin{baitoan}[\cite{Binh_boi_duong_Toan_9_tap_1}, 5.1., p. 112]
	Cho đường tròn $(O)$ có tâm O nằm trên đường phân giác $\angle{xIy}$, $(O)$ cắt tia Ix ở $A,B$ sao cho A nằm giữa $B,I$, cắt tia Iy ở $C,D$ sao cho C nằm giữa $D,I$. Chứng minh: (a) $AB = CD$. (b) $IA = IC,IB = ID$.
\end{baitoan}

\begin{proof}[Chứng minh]
	Kẻ $OH\bot AB,OK\bot CD$ thì $H,K$ lần lượt là trung điểm $AB,CD$. $IO$ là tia phân giác $\angle{xIy}$ (gt) $\Rightarrow OH = OK$ (tính chất đường phân giác\footnote{Hoặc $\Delta OIH = \Delta OIK$ (ch.gn) $\Rightarrow OH = OK$.}) $\Leftrightarrow AB = CD$. (b) Vì $H,K$ lần lượt là 2 hình chiếu vuông góc của điểm $O$ nằm trên tia phân giác $\angle xIy$ lên 2 cạnh $Ix,Iy$ nên $IH = IK$ (1) (tính chất đường phân giác). Từ (a), $AB = CD\Leftrightarrow AH = BH = CK = DK$ (2). Từ (1) \& (2), $IA = IH - AH = IK - CK = IC,IB = IA + AB = IC + CD = ID$.
\end{proof}
...
\begin{proof}[Chứng minh]
	$H,K$ lần lượt là trung điểm $AB,CD\Rightarrow OH\bot AB,OK\bot CD$. Trong $(O;r_2)$, $AB > CD\Leftrightarrow OH < OK$. Trong $(O;r_1)$, $OH < OK\Leftrightarrow ME > MF$. (b) Từ (a) $MH = \frac{1}{2}ME > \frac{1}{2}MF = MK$. 
\end{proof}

\begin{baitoan}[\cite{Binh_boi_duong_Toan_9_tap_1}, 5.3., p. 112]
	Cho đường tròn $(O;{\rm5 cm})$, dây $AB = 8$ {\rm cm}. (a) Tính khoảng cách từ tâm O đến dây AB. (b) Lấy điểm I trên dây AB sao cho $AI = 1$ {\rm cm}. Kẻ dây CD đi qua I \& vuông góc với AB. Chứng minh $AB = CD$.
\end{baitoan}

\begin{proof}[Chứng minh]
	(a) Kẻ $OE\bot AB$ thì $E$ là trung điểm $AB$ nên $AE = BE = \frac{1}{2}AB = 4$ cm, $OE$ là khoảng cách từ tâm $O$ đến dây $AB$. Áp dụng định lý Pythagore cho $\Delta BEO$ vuông tại $E$: $OE = \sqrt{OB^2 - BE^2} = \sqrt{5^2 - 4^2} = 3$ cm. (b) Kẻ $OF\bot CD$ thì $OF$ là khoảng cách từ tâm $O$ đến dây $CD$. Tứ giác $EIFO$ là hình chữ nhật vì có 3 góc vuông, nên $OF = IE = AE - AI = 4 - 1 = 3$ cm, suy ra $OE = OF = 3$ cm $\Leftrightarrow AB = CD$.
\end{proof}
...
\begin{proof}[Chứng minh]
	Xét 2 trường hợp:
	\begin{itemize}
		\item \textit{Trường hợp dây $CD$ không cắt đường kính $AB$}. $CM\bot CD,DN\bot CD\Rightarrow CM\parallel DN\Rightarrow CDNM$ là hình thang. Kẻ $OH\bot CD$ thì $H$ là trung điểm $CD$ (1). Vì $CM,DN,OH$ cùng vuông góc với $CD$ nên $CM\parallel DN\parallel OH$, kết hợp với (1), suy ra $OH$ là đường trung bình của hình thang $CDNM$, nên $OM = ON$, suy ra $AM = OA - OM = OB - ON = BN$.
		\item \textit{Trường hợp dây $CD$ cắt đường kính $AB$ tại 1 điểm $K$}. Kẻ $OH\bot CD$ thì $H$ là trung điểm $CD$ (1). Kẻ $OE\bot CM,E\in CM$ thì tứ giác $OECH$ là hình chữ nhật vì có 3 góc vuông nên $OE = CH$ (2). Kẻ $OF\bot DN,F\in DN$ thì tứ giác $OFDH$ là hình chữ nhật vì có 3 góc vuông nên $OF = DH$ (3). Từ (1)--(3) suy ra $OE = OF$ nên $\Delta OEM = \Delta OFN$ (cgv.gn) $\Rightarrow OM = ON\Rightarrow AM = OM - OA = ON - OB = BN$.
	\end{itemize}
	Vậy $AM = BN$ trong cả 2 trường hợp.
\end{proof}
...
\begin{proof}[Chứng minh]
	Kẻ $OH\bot AB,OK\bot CD$ thì $H,K$ lần lượt là trung điểm $AB,CD$. $AB = CD\Leftrightarrow OH = OK\Leftrightarrow IO$ là tia phân giác $\angle BID$ hoặc $\angle AIC$. (b) 
\end{proof}
...
\begin{proof}[Giải]
	(a) $OO' = OA - O'A\Leftrightarrow d = R - R'\Leftrightarrow(O),(O')$ tiếp xúc trong. (b) $\Delta ACO$ có cạnh $AO$ là đường kính của $(O')$ ngoại tiếp nên $\Delta ACO$ vuông tại $C$ hay $OC\bot AD$, suy ra $AC = CD$.
\end{proof}
...
\begin{baitoan}[\cite{Binh_Toan_9_tap_2}, 364., p. 125]
	Cho đường tròn $(O)$, điểm A cố định trên đường tròn. Trên tiếp tuyến tại A lấy 1 điểm B cố định. $(O')$ là đường tròn tiếp xúc với AB tại B \& có bán kính thay đổi. Tìm quỹ tích các điểm I là trung điểm của dây chung MN của $(O),(O')$.
\end{baitoan}
