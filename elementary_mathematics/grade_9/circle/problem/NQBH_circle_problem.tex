...
\begin{baitoan}[\cite{Binh_boi_duong_Toan_9_tap_1}, VD7, p. 119]
	Cho đường tròn $(O,5\ {\rm cm})$ \& 1 điểm A nằm ngoài đường tròn. Dựng 1 cát tuyến đi qua A, cắt đường tròn theo 1 dây có độ dài {\rm8 cm}.
\end{baitoan}
...
\begin{baitoan}[\cite{Binh_boi_duong_Toan_9_tap_1}, 6.5., p. 120]
	Cho 2 đường thẳng $d\parallel d'$. 1 đường tròn $(O)$ tiếp xúc với $d,d'$ tương ứng tại $C,D$, A là 1 điểm cố định trên $d$, nằm ngoài $(O)$. Chỉ dùng êke, tìm trên $d'$ điểm B sao cho AB là tiếp tuyến của $(O)$.
\end{baitoan}
