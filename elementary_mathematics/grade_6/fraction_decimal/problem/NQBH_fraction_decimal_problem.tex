...
\begin{baitoan}[Mở rộng \cite{Tuyen_Toan_6}, VD50, p. 46]
...
\begin{baitoan}[Mở rộng \cite{Tuyen_Toan_6}, VD51, p. 46]
...
\begin{baitoan}[\cite{Binh_Toan_6_tap_2}, VD1, p. 4]
	Tìm $n\in\mathbb{N}$ để phân số $A = \dfrac{n + 10}{2n - 8}\in\mathbb{Z}$ (i.e., có giá trị là 1 số nguyên).
\end{baitoan}

\begin{baitoan}[Mở rộng \cite{Binh_Toan_6_tap_2}, VD1, p. 4]
...
\begin{baitoan}[Mở rộng \cite{Binh_Toan_6_tap_2}, VD2, p. 5]
...
\begin{baitoan}[Mở rộng \cite{Tuyen_Toan_6}, VD52, p. 48]
	Cho $a,b,c,d\in\mathbb{N}$, $a > b > 0$, $d > c > 0$. So sánh: $\dfrac{\pm a}{\pm b}$ \& $\dfrac{\pm c}{\pm d}$.
\end{baitoan}

\begin{baitoan}[\cite{Tuyen_Toan_6}, VD53, p. 48]
	Sắp xếp các phân số sau theo thứ tự tăng dần: $\dfrac{5}{8},\dfrac{9}{16},\dfrac{2}{-3},\dfrac{-7}{12}$.
\end{baitoan}
...
\fbox{1} Giá trị $\dfrac{m}{n}$ của 1 số $a\in\mathbb{R}$ là $b = a\cdot\dfrac{m}{n} = \dfrac{am}{n}$, $\forall m,n\in\mathbb{N},n\ne0$. \fbox{2} Biết $\dfrac{m}{n}$ của $a\in\mathbb{R}$ bằng $b\in\mathbb{R}$ thì $a = b:\dfrac{m}{n}$, $\forall m,n\in\mathbb{N},n\ne0$.
