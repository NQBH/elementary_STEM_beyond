...
\begin{abstract}
	...
	\begin{itemize}
		...
		PDF: {\sc url}: \url{https://github.com/NQBH/elementary_STEM_beyond/blob/main/elementary_mathematics/grade_6/plane_geometry/problem/NQBH_plane_geometry_problem.pdf}.
		
		\TeX: {\sc url}: \url{https://github.com/NQBH/elementary_STEM_beyond/blob/main/elementary_mathematics/grade_6/plane_geometry/problem/NQBH_plane_geometry_problem.tex}.
		\item {\it Problem \& Solution: Plane Geometry -- Bài Tập \& Lời Giải: Hình Học Phẳng}.
		
		PDF: {\sc url}: \url{https://github.com/NQBH/elementary_STEM_beyond/blob/main/elementary_mathematics/grade_6/plane_geometry/solution/NQBH_plane_geometry_solution.pdf}.
		
		\TeX: {\sc url}: \url{https://github.com/NQBH/elementary_STEM_beyond/blob/main/elementary_mathematics/grade_6/plane_geometry/solution/NQBH_plane_geometry_solution.tex}.
	\end{itemize}
\end{abstract}
\tableofcontents
...
\subsection{Chứng minh các điểm thẳng hàng}
...
\begin{baitoan}
	Trên mặt phẳng, cho $n$ điểm $A_i$, $i = 1,2,\ldots,n$, $n\in\mathbb{N}$, $n\ge3$. Giả sử $3$ điểm bất kỳ trong số chúng đều thẳng hàng. $n$ điểm đó có thẳng hàng không?
\end{baitoan}

\begin{baitoan}
	Trên mặt phẳng, cho $n$ điểm $A_i$, $i = 1,2,\ldots,n$, $n\in\mathbb{N}$, $n\ge3$. Giả sử 3 điểm $A_i,A_{i+1},A_{i+2}$ thẳng hàng $\forall i = 1,2,\ldots,n-2$. $n$ điểm đó có thẳng hàng không?
\end{baitoan}

\begin{baitoan}
	Trên mặt phẳng, cho $n\in\mathbb{N}^\star$ bộ điểm phân biệt không nhất thiết rời nhau lần lượt gồm $a_1,a_2,\ldots,a_n$ điểm thẳng hàng. Tìm điều kiện cần \& đủ để tất cả điểm  của n bộ điểm đó thẳng hàng.
\end{baitoan}

\begin{baitoan}[\cite{Tuyen_Toan_6}, VD9, p. 88]
	Trên đường thẳng $a$ lấy 4 điểm $M,N,P,Q$ theo thứ tự đó. (a) Điểm $N$ nằm giữa 2 điểm nào? (b) Điểm $P$ không nằm giữa 2 điểm nào?
\end{baitoan}
...
\subsection{Chứng minh các đường thẳng song song, đồng quy}
...
\subsection{Đếm số đường thẳng, số giao điểm}

\begin{baitoan}[Count number of lines formed by some points -- đếm số đường thẳng tạo bởi 1 số điểm]
	Chứng minh: (a) Có $C_n^2 = \dfrac{n(n - 1)}{2}$ đoạn thẳng tạo bởi n điểm phân biệt. (b) Có $C_n^2 = \dfrac{n(n - 1)}{2}$ đường thẳng tạo bởi n điểm phân biệt trong đó không có 3 điểm nào thẳng hàng. (c) Có $C_n^2 - \sum_{i=1}^m C_{a_i}^2 + m = \dfrac{n(n - 1)}{2} - \sum_{i=1}^m \dfrac{a_i(a_i - 1)}{2} + m$ đường thẳng tạo bởi n điểm trong đó có đúng $m\in\mathbb{N}$ bộ lần lượt gồm $a_1,a_2,\ldots,a_m$ điểm thẳng hàng.
\end{baitoan}
...
\begin{baitoan}[Count number of intersections formed by some lines -- đếm số giao điểm tạo bởi 1 số đường thẳng]
	(a) Tính số giao điểm của 4 đường thẳng phân biệt. (b) Chứng minh có $C_n^2 - \sum_{i=1}^m C_{a_i}^2 - \sum_{i=1}^k C_{b_i}^2 + k = \dfrac{n(n - 1)}{2} - \sum_{i=1}^m \dfrac{a_i(a_i - 1)}{2} - \sum_{i=1}^k \dfrac{b_i(b_i - 1)}{2} + k$ giao điểm của $n\in\mathbb{N}^\star$ đường thẳng phân biệt trong đó có đúng $m\in\mathbb{N}$ bộ lần lượt gồm $a_1,a_2,\ldots,a_m$ đường thẳng song song đôi một \& $k\in\mathbb{N}$ bộ lần lượt gồm $b_1,b_2,\ldots,b_k$ đường thẳng đồng quy tại 1 điểm.
\end{baitoan}
...
\begin{baitoan}[\cite{Tuyen_Toan_6}, VD8, p. 87, \cite{Binh_Toan_6_tap_2}, 1., p. 65]
	Cho 4 điểm $A,B,C,D$ sao cho 3 điểm $A,B,C$ thẳng hàng; 3 điểm $B,C,D$ cũng thẳng hàng. 4 điểm $A,B,C,D$ có thẳng hàng không? Vì sao?
\end{baitoan}

\begin{baitoan}[\cite{Tuyen_Toan_6}, VD10, p. 88]
	Cho $12$ điểm trong đó không có 3 điểm nào thẳng hàng. Cứ qua 2 điểm vẽ 1 đường thẳng. (a) Vẽ được tất cả bao nhiêu đường thẳng? (b) Nếu thay $12$ điểm bằng $n$ điểm, $n\in\mathbb{N}$, $n\ge2$, thì vẽ được bao nhiêu đường thẳng?
\end{baitoan}
...
\begin{baitoan}[\cite{Tuyen_Toan_6}, 39., p. 89]
	Trái Đất quay quanh Trời, Mặt Trăng quay quanh Trái Đất. Mặt Trời chiếu sáng tới Trái Đất \& Mặt Trăng. Khi 3 thiên thể này thẳng hàng thì xảy ra nhật thực hoặc nguyệt thực (là hiện tượng Mặt Trời hoặc Mặt Trăng đang sáng bỗng nhiên bị che lấp \& tối đi). (a) Khi xảy ra nhật thực thì Mặt Trăng ở vị trí nào? (b) Khi xảy ra nguyệt thực thì Trái Đất ở vị trí nào?
\end{baitoan}
...
\begin{baitoan}[\cite{Tuyen_Toan_6}, 44., p. 89]
	Cho 3 điểm $C,O,D$ thẳng hàng. Biết điểm $C$ không nằm giữa 2 điểm $O,D$, điểm $O$ không nằm giữa 2 điểm $C,D$. trong 3 điểm đã cho, điểm nào nằm giữa 2 điểm còn lại?
\end{baitoan}

\begin{baitoan}[\cite{Tuyen_Toan_6}, 45., p. 89]
	Cho 3 điểm $A,B,C$ trong đó không có điểm nào nằm giữa 2 điểm còn lại. 3 điểm $A,B,C$ có thẳng hàng không?
\end{baitoan}

\begin{baitoan}[\cite{Tuyen_Toan_6}, 46., p. 89]
	Cho 6 điểm. Cứ qua 2 điểm vẽ 1 đường thẳng. (a) Nếu trong 6 điểm đó không có 3 điểm nào thẳng hàng thì sẽ vẽ được bao nhiêu đường thẳng? (b) Nếu trong 6 điểm đó có đúng 3 điểm thẳng hàng thì sẽ vẽ được bao nhiêu đường thẳng?
\end{baitoan}
...
\begin{baitoan}[\cite{Tuyen_Toan_6}, 49., p. 89]
	Cho 11 đường thẳng đôi một cắt nhau. (a) Nếu trong số đó không có 3 đường thẳng nào cùng đi qua 1 điểm thì có tất cả bao nhiêu giao điểm của chúng? (b) Nếu trong 11 đường thẳng đó có đúng 5 đường thẳng cùng đi qua 1 điểm thì có tất cả bao nhiêu giao điểm của chúng?
\end{baitoan}
...
\subsection{Trồng cây}

\begin{baitoan}[Tree problem -- bài toán trồng cây]
	Cho $a,b,c\in\mathbb{N}^\star$. Trồng a cây thành b hàng, mỗi hàng c cây. Vẽ b đường thẳng đi qua a điểm, mỗi đường thẳng gồm đúng c điểm.
\end{baitoan}
...
\begin{baitoan}[\cite{Binh_Toan_6_tap_2}, 6., p. 65]
	(a) Xếp $10$ điểm thành $5$ hàng, mỗi hàng có $4$ điểm. (b) Xếp $7$ điểm thành $6$ hàng, mỗi hàng có $3$ điểm. (c) Người ta trồng $12$ cây thành $6$ hàng, mỗi hàng có $4$ cây. Vẽ sơ đồ vị trí của $12$ cây đó. (d$\star$) Xếp a điểm thành b hàng, mỗi hàng có c cây với $a,b,c\in\mathbb{N}^\star$. Tìm điều kiện của $a,b,c$ để việc sắp xếp như vậy là khả thi.
\end{baitoan}
...
\begin{baitoan}
	So sánh đoạn thẳng với đường thẳng.
\end{baitoan}
...
\begin{baitoan}[\cite{TLCT_THCS_Toan_6_hinh_hoc}, 1.1., pp. 20--21]
	Cho 6 điểm $A,B,C,O,M,N$ sao cho $A,B,C$ không thẳng hàng, $A,B,O$ thẳng hàng, $O,C,M$ thẳng hàng, $C,M,N$ thẳng hàng. (a) Chứng minh $O,C,M,N$ cùng thuộc 1 đường thẳng. (b) 2 đường thẳng $MN,AB$ trùng nhau không? (c) Cứ qua 2 điểm vẽ 1 đường thẳng. Đếm số đường thẳng được vẽ \& liệt kê.
\end{baitoan}
...
\begin{baitoan}[\cite{TLCT_THCS_Toan_6_hinh_hoc}, 1.8., p. 21]
	Cho n điểm, nối từng cặp 2 điểm. (a) Tính số đoạn thẳng khi $n = 100$. (b) Tìm n để số đoạn thẳng bằng tổng các số từ $1$ đến $99$. (c) Tìm n để số đoạn thẳng bằng tổng các số từ $1$ đến $m\in\mathbb{N}^\star$.
\end{baitoan}
...
\begin{baitoan}[\cite{TLCT_THCS_Toan_6_hinh_hoc}, VD2.4, p. 24]
	3 điểm A,B,C hàng không nếu: (a) $AB = 2,BC = 7,AC = 5$? (b) $AB = 3,BC = 7,AC = 5$? (c) Đặt $BC = a,CA = b,AB = c$. Tìm điều kiện của $a,b,c\in(0,\infty)$ để: (i) A,B,C thẳng hàng. (ii) A,B,C không thẳng hàng.\hfill{\sf Ans: $a + b + c = 2\max\{a,b,c\}$, $a + b + c\ne\max\{a,b,c\}$.}
\end{baitoan}
...
\begin{baitoan}[\cite{Binh_boi_duong_Toan_6_tap_2}, 13.11., p. 76]
	Cho đoạn thẳng $AB = 7.5$. E nằm giữa A,B sao cho $AE = \frac{2}{3}AB$. F là trung điểm AE. Chứng minh: (a) $AF = EF = BE$. (b) E là trung điểm BF.
\end{baitoan}
...
\section{Angle -- Góc}
\fbox{1} \textit{Góc} là 1 hình gồm 2 tia chung gốc. Gốc chung của tia gọi là \textit{đỉnh} của góc, 2 tia gọi là 2 \textit{cạnh} của góc. Có nhiều cách ký hiệu 1 góc, e.g., góc $xOy$, góc $MON$, góc $O$, $\angle xOy,\widehat{xOy},\widehat{MON}$. \fbox{2} \textit{Góc bẹt} là góc có 2 cạnh là 2 tia đối nhau. \fbox{3} Để vẽ góc thì vẽ đỉnh \& vẽ 2 cạnh của góc. Dùng thước đo góc để đo độ lớn của 1 góc. \fbox{4} $M$ là điểm trong của $\widehat{xOy}\Leftrightarrow$ tia $OM$ nằm giữa 2 tia $Ox,Oy\Leftrightarrow$ tia $OM$ nằm trong $\widehat{xOy}$. \fbox{5} Tia nằm giữa 2 tia luôn cắt đoạn thẳng nối 2 điểm thuộc 2 tia đó.

\begin{baitoan}[\cite{Binh_boi_duong_Toan_6_tap_2}, H5, p. 79]
	Các điểm nằm giữa A,C có là điểm trong của $\widehat{ABC}$?
\end{baitoan}

\begin{baitoan}[\cite{Binh_boi_duong_Toan_6_tap_2}, VD4, p. 80]
	Chứng minh $n\in\mathbb{N}^\star$ tia chung gốc tạo thành tất cả $\dfrac{n(n - 1)}{2}$ góc.
\end{baitoan}

\begin{baitoan}[\cite{Binh_boi_duong_Toan_6_tap_2}, VD5, p. 81]
	Cho 4 tia Ox,Oy,Oz,Ot với 2 tia Ox,Oy không đối nhau. Tia Ot nằm giữa 2 tia Ox,Oy, tia Oz nằm giữa 2 tia Oy,Ot. Tia Oz có nằm giữa 2 tia Ox,Oy không?
\end{baitoan}

\begin{baitoan}[\cite{Binh_boi_duong_Toan_6_tap_2}, 14.2., p. 81]
	Với 3 đường thẳng, vẽ được nhiều nhất mấy góc?
\end{baitoan}

\begin{baitoan}[\cite{Binh_boi_duong_Toan_6_tap_2}, 14.4., p. 81]
	Vẽ 2 tia Ox,Oy. Trên tia Ox lấy điểm A, trên tia Oy lấy điểm B. Lấy điểm C nằm giữa A,B. C có là điểm trong của $\widehat{xOy}$?
\end{baitoan}

\begin{baitoan}[\cite{Binh_boi_duong_Toan_6_tap_2}, 14.5., p. 81]
	Chiếc quạt giấy có $17$ nan kể cả 2 nan ngoài cùng. Tính số góc tạo bởi các nan quạt.
\end{baitoan}

\begin{baitoan}[\cite{Binh_boi_duong_Toan_6_tap_2}, 14.6., p. 81]
	Có $n\in\mathbb{N}^\star$ tia chung gốc tạo thành tất cả $55$ góc. Tính n.
\end{baitoan}

\begin{baitoan}[\cite{Binh_boi_duong_Toan_6_tap_2}, 14.7., p. 81]
	Có điểm nằm trong \& tia nằm trong góc bẹt không?
\end{baitoan}

\begin{baitoan}[\cite{Binh_boi_duong_Toan_6_tap_2}, p. 81]
	Cho tia Oz nằm giữa 2 tia Ox,Oy không đối nhau. Tia Ob nằm giữa 2 tia Ox,Oz, tia Oa nằm giữa 2 tia Oy,Oz. Tia Oz có nằm giữa 2 tia Oa,Ob không? 
\end{baitoan}
...
\begin{baitoan}[\cite{TLCT_THCS_Toan_6_hinh_hoc}, VD4.2, p. 41]
	Đếm số góc tạo bởi: (a) $3$ tia chung gốc OA,OB,OC theo thứ tự đó. (b) $4$ tia chung gốc OA,OB,OC,OD theo thứ tự đó. (c) $5$ tia chung gốc OA,OB,OC,OD,OE theo thứ tự đó. (d) $100$ tia chung gốc. (e) $n\in\mathbb{N}^\star$ tia chung gốc.
\end{baitoan}
...
\fbox{1} Mỗi góc có 1 số đo, số đo của mỗi góc $\le180^\circ$. Đơn vị của góc là độ, phút, giây: $1^\circ = 60',1' = 60''$. Các góc đặc biệt: góc nhọn $0^\circ < \alpha < 90^\circ$, góc vuông $\alpha = 90^\circ$, góc tù $90^\circ < \alpha < 180^\circ$, góc bẹt $\alpha = 180^\circ$, góc lõm $180^\circ < \alpha < 360^\circ$, góc đầy $\alpha = 360^\circ$. \fbox{2} So sánh 2 góc bằng cách so sánh các số đo của chúng. \fbox{3} Nếu tia $Oy$ nằm giữa 2 tia $Ox,Oz$ thì $\widehat{xOy} + \widehat{yOz} = \widehat{xOz}$. \fbox{4} {\sf Dấu hiệu về thứ tự của tia}: Nếu có đẳng thức về góc $\widehat{xOy} + \widehat{yOz} = \widehat{xOz}$ thì tia $Oy$ nằm giữa 2 tia $Ox,Oz$. \fbox{5} {\sf Dấu hiệu về thứ tự của tia}: Nếu 2 tia $Oy,Oz$ cùng thuộc nửa mặt phẳng bờ chứa tia $Ox$ \& có $\widehat{xOy} < \widehat{xOz}$ thì tia $Oy$ nằm giữa 2 tia $Ox,Oz$. \fbox{6} $\widehat{xOy},\widehat{yOz}$ kề nhau thỏa $\widehat{xOy} + \widehat{yOz} = n^\circ$. Nếu $n\le180$ thì $\widehat{xOz} = n^\circ$. Nếu $n > 180$ thì $\widehat{xOz} = 360^\circ - n^\circ$.

\begin{baitoan}[\cite{Binh_boi_duong_Toan_6_tap_2}, H2, p. 84]
	Sắp xếp tăng dần: góc nhọn, góc tù, góc bẹt, góc vuông.
\end{baitoan}

\begin{baitoan}[\cite{Binh_boi_duong_Toan_6_tap_2}, H3, p. 84]
	Góc tạo bởi kim giờ \& kim phút là góc vuông vào các giờ nào?
\end{baitoan}

\begin{baitoan}
	Số đo góc tạo bởi kim giờ \& kim phút bằng $\alpha\in[0^\circ,180^\circ]$ vào các giờ nào?
\end{baitoan}

\begin{baitoan}[\cite{Binh_boi_duong_Toan_6_tap_2}, H4, p. 84]
	Vào các giờ nào trong ngày, góc tạo bởi kim giờ \& kim phút là góc nhọn, góc vuông, góc tù, góc bẹt?
\end{baitoan}

\begin{baitoan}[\cite{Binh_boi_duong_Toan_6_tap_2}, VD3, p. 86]
	Cho $\widehat{mOn} = 30^\circ$. Vẽ tiếp $\widehat{nOt} = 60^\circ$. Tính $\widehat{mOt}$.
\end{baitoan}

\begin{baitoan}[\cite{Binh_boi_duong_Toan_6_tap_2}, VD4, p. 86]
	Cho $\widehat{xOy} = 30^\circ$. Vẽ $\widehat{yOz}$ kề phụ với $\widehat{xOy}$. Vẽ $\widehat{zOt} = 90^\circ$. Tính $\widehat{xOt}$.
\end{baitoan}

\begin{baitoan}[\cite{Binh_boi_duong_Toan_6_tap_2}, VD5, p. 86]
	Tính số đo của góc giữa 2 cánh của 1 chiếc quạt trần 3 cánh.
\end{baitoan}

\begin{baitoan}[\cite{Binh_boi_duong_Toan_6_tap_2}, VD6, p. 87]
	Cho $\widehat{xOy} = 140^\circ,\widehat{xOz} = 170^\circ$. Tính $\widehat{yOz}$.
\end{baitoan}

\begin{baitoan}[\cite{Binh_boi_duong_Toan_6_tap_2}, 15.1., p. 87]
	Vẽ $\widehat{xOy} = \alpha = 55^\circ$. Vẽ tiếp $\widehat{yOz} = \beta = 25^\circ$. Tính $\widehat{xOz}$.
\end{baitoan}

\begin{baitoan}[\cite{Binh_boi_duong_Toan_6_tap_2}, 15.2., p. 87]
	Cho 2 góc kề nhau $\widehat{xOy} = 45^\circ,\widehat{yOz}$. Biết $\widehat{xOz} = 80^\circ$. Tính $\widehat{yOz}$.
\end{baitoan}

\begin{baitoan}[\cite{Binh_boi_duong_Toan_6_tap_2}, 15.3., p. 87]
	Cho tia Oc nằm giữa 2 tia Oa,Ob. Biết $\widehat{aOb} = 85^\circ$, $\widehat{aOc}$ nhỏ hơn $\widehat{bOc}$ $15^\circ$. Tính $\widehat{aOc},\widehat{bOc}$.
\end{baitoan}

\begin{baitoan}[\cite{Binh_boi_duong_Toan_6_tap_2}, 15.4., p. 87]
	Cho $\widehat{xOy},\widehat{yOz}$ phụ nhau, $\widehat{yOz} = 4\widehat{xOy}$. Tính số đo mỗi góc.
\end{baitoan}

\begin{baitoan}[\cite{Binh_boi_duong_Toan_6_tap_2}, 15.5., p. 87]
	Cho $\widehat{A},\widehat{O}$ bù nhau, $\widehat{O} = 2\widehat{A}$. Tính số đo mỗi góc.
\end{baitoan}

\begin{baitoan}[\cite{Binh_boi_duong_Toan_6_tap_2}, 15.6., p. 87]
	Cho $\widehat{xOy} = 120^\circ$. Ot là tia đối của tia Ox. Vẽ $\widehat{tOz} = 45^\circ$, Oz,Oy khác phía đối với tx. Tính $\widehat{yOz}$.
\end{baitoan}

\begin{baitoan}[\cite{Binh_boi_duong_Toan_6_tap_2}, 15.7., p. 87]
	Cho 4 góc kề xOy,yOz,zOt,tOx với $\widehat{yOz} = 2\widehat{xOy},\widehat{zOt} = 3\widehat{xOy},\widehat{tOx} = 4\widehat{xOy}$. Tính số đo mỗi góc.
\end{baitoan}

\begin{baitoan}[\cite{Binh_boi_duong_Toan_6_tap_2}, 15.8., p. 87]
	Cho 4 tia OA,OB,OC,OD theo thứ tự đó với $\widehat{AOB} = 90^\circ,\widehat{BOD} = 55^\circ,\widehat{AOC} = 125^\circ$. Tính $\widehat{COD}$.
\end{baitoan}
...
\begin{baitoan}[\cite{Binh_Toan_6_tap_2}, 47., p. 76]
	Cho điểm O nằm trong $\Delta ABC$. Chứng minh: (a) Tia BO cắt đoạn thẳng AC tại 1 điểm D nằm giữa $A,C$. (b) Điểm O nằm giữa $B,D$. (c) Trong 3 tia $OA,OB,OC$, không có tia nào nằm giữa 2 tia còn lại.
\end{baitoan}
...
\begin{baitoan}[Đếm số đoạn thẳng, đường thẳng tổng quát]
	Cho $n\in\mathbb{N},n\ge2$. (a) Cho $n$ điểm trong đó không có 3 điểm nào thẳng hàng, đếm số đoạn thẳng, đường thẳng, tia đi qua 2 điểm trong chúng. (b) Cho $n$ điểm trong đó có đúng 1 bộ $m$ điểm thẳng hàng với nhau, đếm số đoạn thẳng, đường thẳng đi qua 2 điểm trong chúng. (c) Cho $n$ điểm trong đó có đúng $m$ bộ điểm thẳng hàng với nhau lần lượt nằm trên các đường thẳng $a_1,a_2,\ldots,a_m$. Biết đường thẳng $a_i$ có đúng $a_i$ điểm trong $n$ điểm đã cho thẳng hàng. Đếm số đoạn thẳng, đường thẳng đi qua 2 điểm trong chúng.
\end{baitoan}

\begin{baitoan}[Đếm số góc, tam giác tổng quát]
	Cho $n\in\mathbb{N},n\ge2$. (a) Cho $n$ điểm trong đó không có 3 điểm nào thẳng hàng, đếm số góc, số tam giác tạo bởi chúng. (b) Cho $n$ điểm trong đó có đúng 1 bộ $m$ điểm thẳng hàng với nhau, đếm số góc, số tam giác tạo bởi chúng. (c) Cho $n$ điểm trong đó có đúng $m$ bộ điểm thẳng hàng với nhau lần lượt nằm trên các đường thẳng $a_1,a_2,\ldots,a_m$. Biết đường thẳng $a_i$ có đúng $a_i$ điểm trong $n$ điểm đã cho thẳng hàng. Đếm số góc, số tam giác tạo bởi chúng.
\end{baitoan}
