...
\begin{baitoan}
	Cho độ dài 3 cạnh của 1 tam giác. (a) Tính độ dài 3 đường phân giác trong \& 6 đoạn tạo thành trên 3 cạnh. (b) Tính khoảng cách từ tâm đường tròn nội tiếp I đến 3 đỉnh \& 3 cạnh.
	\begin{align*}
...
\begin{enumerate}
	\item \cite{Phuong_Quan_ptb3_htl}. {\sc Tạ Duy Phượng, Hoàng Minh Quân}. {\it Phương Trình Bậc 3 với Các Hệ Thức Hình Học \& Lượng Giác Trong Tam Giác}.
\end{enumerate}
