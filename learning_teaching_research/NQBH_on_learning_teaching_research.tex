...
\begin{itemize}
	\item {\it Original style}: khi bắt đầu tự học về nghề viết, chúng tôi bắt đầu tham khảo từ quyển {\it The Elements of Style} \cite{Strunk1918,Strunk_White2019} của giáo sư tiếng Anh người Mỹ {\sc William Strunk Jr.} tại Đại học Cornell.
...
\begin{itemize}
	\item \cite{Ichiro_Fumitake_disliked}. {\sc Kishimi Ichiro \& Koga Fumiake}. {\it The Courage to Be Disliked: The Japanese Phenomenon That Shows You How to Change Your Life and Achieve Real Happiness}. Với bản dịch tiếng Việt:
	\item \cite{Ichiro_Fumitake_disliked_VN}. {\sc Kishimi Ichiro \& Koga Fumiake}. {\it The Courage to Be Disliked: The Japanese Phenomenon That Shows You How to Change Your Life and Achieve Real Happiness -- Dám Bị Ghét}.
	\item \cite{Ichiro_Fumitake_happy}. {\sc Kishimi Ichiro \& Koga Fumiake}. {\it The Courage to Be Happy: Discover the Power of Positive Psychology and Choose Happiness Every Day}. Với bản dịch tiếng Việt:
	\item \cite{Ichiro_Fumitake_happy_VN}. {\sc Kishimi Ichiro \& Koga Fumiake}. {\it The Courage to Be Happy: Discover the Power of Positive Psychology and Choose Happiness Every Day -- Dám Hạnh Phúc}.
\end{itemize}
...
\begin{itemize}
	...
	\item \cite{Duhigg_habit}. {\sc Charles Duhigg}. {\it The Power of Habit: Why We Do What We Do in Life and Business}. Với bản dịch tiếng Việt:
	\item \cite{Duhigg_habit_VN}. {\sc Charles Duhigg}. {\it The Power of Habit: Why We Do What We Do in Life and Business -- Sức Mạnh Của Thói Quen}.
\end{itemize}
...
\begin{itemize}
	...
	\item \cite{Tolle_oneness}. {\sc Eckhart Tolle}. {\it Oneness With All Life}. Với bản dịch tiếng Việt:
...
\begin{psy-theorem}[Eidetic memory vs. $\Phi$-manipulation]
	A combination of eidetic memory \& a sharp critical thinking is a natural enemy of psychological manipulation. Consequently, eidetiker with a sharp critical thinking is a natural enemy of psychological manipulators.
	
	-- 1 tổ hợp của trí nhớ điện tử \& 1 tư duy phản biện sắc bén là 1 trong những thiên địch của thao túng tâm lý. Hệ quả là kẻ có trí nhớ điện tử với 1 tư duy phản biện sắc bén là 1 trong những thiên địch của các kẻ thao túng tâm lý.
\end{psy-theorem}
