...
\usepackage{amsmath,amssymb,amsthm,fancyvrb,float,graphicx,mathtools,multicol,soul,subfig}
\allowdisplaybreaks
...
\subsubsection{Some Topics in Elementary Mathematics}
...
\paragraph{Elementary Mathematics Grade 6}
...
\paragraph{Elementary Mathematics Grade 7}
...
\paragraph{Elementary Mathematics Grade 8}
...
\paragraph{Elementary Mathematics Grade 9}
...
\paragraph{Elementary Mathematics Grade 10}

\paragraph{Elementary Mathematics Grade 11}
...
\paragraph{Elementary Mathematics Grade 12}
...
\subsubsection{Bridges from Elementary Mathematics to Advanced Mathematics}

%------------------------------------------------------------------------------%

\subsubsection{Some Topics in Elementary Physics}
...
\subsubsection{Some Topics in Elementary Computer Science}
...
\subsubsection{Some Topics in Elementary Chemistry}
...
\begin{psy-theorem}[Eidetic memory vs. $\Phi$-manipulation]
	A combination of eidetic memory and a sharp critical thinking is a natural enemy of psychological manipulation. Consequently, eidetiker with a sharp critical thinking is a natural enemy of psychological manipulators.
