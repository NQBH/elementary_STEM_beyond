...
\end{itemize}
Trước khi đi vào phần chính của Tiểu thuyết này, chúng tôi muốn xưng trước vài tội đối với độc giả (đương nhiên chúng tôi sẽ không xưng hết tội mà sẽ giấu đa số tội, chỉ để lộ vài tội quan trọng \& nghiêm trọng).
\begin{enumerate}
	\item {\sf Confession on linguistics -- Thú tội về mặt ngôn ngữ}: 2 đoạn tiếng Anh {\sf[en]} \& tiếng Việt {\sf[vi]} (gộp chung lại thì tựa như envy?) là do chúng tôi tự viết, còn 2 đoạn tiếng Pháp {\sf[fr]} \& tiếng Đức {\sf[de]} là tôi xài \href{https://translate.google.com}{\sf Google Translate{\tt/}Dịch}. Các đoạn tiếng Pháp hoặc tiếng Đức, nếu có xuất hiện trong tiểu thuyết này \& nếu không phải được trích dẫn từ các nguồn chính thống nào đấy, thường là sẽ do chúng tôi sử dụng \href{https://translate.google.com}{\sf Google Translate{\tt/}Dịch}\footnote{Official Website: \url{https://translate.google.com/}.} hoặc \href{https://chatgpt.com/}{\sf ChatGPT}\footnote{Official website: \url{https://chatgpt.com/}.}.
	
	\item {\sf Confession on version -- Thú tội về phiên bản}: There is no final version of this short novel, only the latest one.
	
	-- Không có phiên bản cuối cùng của tiểu thuyết này, chỉ có bản cập nhập mới nhất mà thôi.
\end{enumerate}

\subsection{Wonder -- Tự Vấn}

\begin{question}
	Why can't I focus on literally anything? What should I do with my life?
