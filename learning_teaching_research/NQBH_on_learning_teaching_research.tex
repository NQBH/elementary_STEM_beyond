...
\begin{quote}
	{\sf Nhân [25; sex addicted naive boy]:} Nếu có thể miêu tả cảm giác của tui về kẻ ái kỷ, đặc biệt là nữ giới thì có lẽ sẽ là như thế này: 1 con ả ái kỷ sẽ tạo cho bạn cảm giác là ả ta có cái \st{lồn} âm đạo khít, ngon, \& ngọt nước nhất mà bạn từng được biết đến trong đời, \& bạn sẽ phải làm nô dịch để ả ta sai này khiến nọ, cầm lên bỏ xuống, lúc quan tâm lúc thờ ơ như 1 món sex toy tự ảo tưởng về giá trị của bản thân, không phải theo nghĩa vật lý hay sin học, mà theo nghĩa về tâm lý \& tinh thần.
