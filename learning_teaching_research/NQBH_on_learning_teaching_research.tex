...
\begin{quote}
	...
	-- Tôi không biết. Thế đéo mà tôi biết được cơ chứ. Có quá nhiều điều để đáng tiếc trong cái cuộc sống chó chết này theo nhiều phương diện. Thế theo ông là cái quái gì?
	
	{\sf Hồng [?; humble philosopher ready to die]}: A talented or even multi-talented man without any piece of arts, with no contribution and no legacy for the next generation after him. Such a terrible \& accursed waste of giftedness!
...
\section{On Writing: Literary writing for a literary retard -- Bàn về việc viết}
...
\subsection{A summary list of principles}

\subsection{A summary list of rules}

\subsection{A summary list of $\Psi$-theorems, $\Phi$-theorems}
