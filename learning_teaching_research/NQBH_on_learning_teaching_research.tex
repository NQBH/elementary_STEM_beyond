...
\maketitle
\begin{abstract}	
	{\sf[en]} This short novel consists of some pieces of my writing, which are able to be shared {\it\&} I am willing to share, in order to sharpen my flows of thoughts, to balance my scientific work via various aesthetic forms, {\it\&} to track psychologically \& mentally my transitions from boyhood to manhood if there is any.
	\vspace{2mm}
	...
	{\sf[de]} Dieser Kurzroman besteht aus einigen Teilen meines Schreibens, die geteilt werden können {\it\&} Ich bin bereit, sie zu teilen, um meine Gedankenflüsse zu schärfen, meine wissenschaftliche Arbeit durch verschiedene ästhetische Formen auszubalancieren, {\it\&} um meine Übergänge vom Jungen- zum Mannesalter psychologisch und mental zu verfolgen, falls es welche gibt.	
\end{abstract}
...
\textbf{\textsf{\small Vocabulary -- Từ vựng.}}
\begin{itemize}\small
	\item {\sf confess} [v] {\tt/}\textipa{k@n'fes}{\tt/}: 1. to admit, especially formally or to the police, that you have done sth wrong or illegal; 2. to admit sth that you feel ashamed or embarrassed about; 3. {confess (sth) (to sb)} (especially in the Roman Catholic Church) to tell God or a priest about the bad things you have done so that you can say that you are sorry \& be forgiven; 4. {\sf confess sb} (of a priest) to hear sb confess their sins ($=$ the bad things they have done).
	\item {\sf confession} [n] {\tt/}\textipa{k@n'feSn}{\tt/}: 1. a statement that a person makes, admitting that they are guilty of a crime; the act of making such a statement; 2. a statement admitting sth that you are ashamed or embarrassed about; the act of making such a statement, $=$ {\sf admission}; 3. (especially in the Roman Catholic Church) a private statement to a priest about the bad things that you have done; an occasion when you make such a statement; 4. a statement of your religious beliefs, principles, etc.
\end{itemize}
...
\textbf{\textsf{\small Vocabulary -- Từ vựng.}}
\begin{itemize}\small
	\item {\sf wonder} [v] {\tt/}\textipa{`w2nd@r}{\tt/} 1. to think about sth \& try to decide what is true, what will happen, what you should do, etc.; 2. {\it wonder if, whether $\ldots$} used as a polite way of asking a question or asking sb to do sth; 3. to be very surprised by sth. [n] 1. a feeling of surprise \& pleasure that you have when you see or experience sth beautiful, unusual or unexpected, $=$ {\sf awe}; 2. sth that fills you with surprise \& pleasure; 3. a person who is very clever at doing sth; a person or thing that seems very good or effective.
\end{itemize}
...
\begin{enumerate}
	\item Why can't I focus on literally anything? What should I do with my life?
	
	-- Tại sao tôi{\tt/}ta{\tt/}mình không thể tập trung vào bất cứ thứ gì cả theo nghĩa đen? Tôi nên làm cái quái gì với cuộc sống của tôi đây?
	\item {\sf Job \& career -- Nghề nghiệp, sự nghiệp.} What job should I do?
...
\textbf{\textsf{\small Vocabulary -- Từ vựng.}}
\begin{itemize}\small
	\item {\sf translate} [v] {\tt/}\textipa{tr\ae nz`leIt}{\tt/} 1. to express the meaning of speech or writing in a different language; 2. to be changed from 1 language to another; 3. to change sth into a different form; to lead to a particular result; 4. {\it translate (sth) (as sth)} to understand sth in a particular way or give sth a particular meaning, $=$ {\sf interpret}.
	\item {\sf translation} [n] {\tt/}\textipa{tr\ae nz`leISn}{\tt/} 1. the process of changing sth that is written or spoken into another language; 2. a text or word that has been changed from 1 language into another; 3. {\it translation (of sth) into sth} the process of changing sth into a different form.
...
$\ldots$ hoặc, {\it Điện thoại ngu vs. Điện thoại khôn}, hoặc, {\it Điện thoại cùi bắp vs. Điện thoại thông minh}.
...
\begin{itemize}\small
	...
	\item {\sf simplify} [v] {\tt/}\textipa{'sImpl@,faI}{\tt/} {\it simplify sth}: to make something easier to do or understand.
...
\textbf{\textsf{\small Vocabulary -- Từ vựng.}}
\begin{itemize}\small
	\item {\sf rigor{\tt/}rigour} [n] {\tt/}\textipa{`rIg@r}{\tt/} 1. the fact of being careful \& paying great attention to detail, e.g., academic {\tt/}intellectual{\tt/}scientific, etc. rigor; 2. the fact of being strict or severe $=$ {\sf severity}; 3. {\sf the rigors of sth} the difficulties \& unpleasant conditions of sth.
	\item {\sf rigorous} [a] 
\end{itemize}
...
\begin{itemize}\small
	...
	\item {\sf dehumanize} [v] {\tt/}\textipa{,di'hyum@,naIz}{\tt/} {\it dehumanize sb} to make someone lose their human qualities e.g. kindness, understanding, etc. Ex: the dehumanizing effects of poverty and squalor. {\sf dehumanization} [n] {\tt/}\textipa{,di'hyum@,n@'zeISn}{\tt/}
\end{itemize}
...
\begin{enumerate}
	...
	\item \href{https://tuoitre.vn/giao-su-35-tuoi-phan-thanh-nam-va-nhung-con-duong-sau-dai-hoc-20200515114136566.htm}{Tuổi Trẻ Online{\tt/}GS 35 tuổi {\sc Phan Thành Nam} \& những con đường `sau đại học'}.
\end{enumerate}
