...
\begin{example}[Dehumanize operator]
	$\operatorname{dehumanize}:\Psi(P)\to\Psi(P)$ transforms a good person into a bad one, or at least non-good anymore, transforms a giver into a taker, or at least a matcher.
\end{example}
...
\subsection{1 vài câu hỏi tự vấn}
