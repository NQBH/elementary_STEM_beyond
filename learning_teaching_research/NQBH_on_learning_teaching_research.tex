...
\end{itemize}
Điển hình 1 người học Toán, đặc biệt là Đại số (Algebra) có thể thành thạo các thao tác đại số (algebraic manipulations) như cộng $+$, trừ $-$, nhân $\cdot$, chia $:$, nhưng liệu người đó có đủ kiến thức về tâm lý để chuẩn bị cho 1 dạng manipulation ở 1 địa hạt khác với địa hạt của Khoa học nói chung \& của Toán học nói riêng, khi người đó trưởng thành \& bước vào môi trường làm việc không?

\begin{question}
	What is ``psychological manipulation''? Why? \& how to detect and conquer it
\end{question}
