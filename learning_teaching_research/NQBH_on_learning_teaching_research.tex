...
\begin{enumerate}
	...
	\item Các bài toán khó nhất nên được đánh dấu $\star$ truyền thống, \& các bài toán tổng quát nhất, đủ tổng quát để chứa nhiều bài toán khác như 1 trường hợp riêng thì nên đóng khung hoặc in đậm để phân biệt với các bài toán khác.
