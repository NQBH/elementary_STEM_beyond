...
\noindent{\tt {\color{cyan}{\it int}} {\color{YellowGreen} main} ({\color{cyan}{\it int}} argc, {\color{cyan}{\it char}} *argv[]) \{}

Just another winter's day $\ldots$
\begin{figure}[H]
	\centering
...
\begin{quote}
	...
	Tôi khá khó chịu khi các sách về Tâm Lý Học thường để chú thích ở cuối sách. Đối với các nhà Khoa học, đặc biệt là cách nhà Toán học, họ thường dùng footnote hơn. Như thế có thể tra cứu ngay, tiết kiệm thời gian lật hoặc scroll chuột tìm kiếm. Về phương diện này thì Natural Science win Social Science trong cách thiết kế \& phong cách viết. {\sc Donald Erwin Knuth} \& bộ sách huyền thoại {\it The Art of Computer Programming} \cite{Knuth1997,Knuth1998} là 1 ví dụ kinh điển.
\end{quote}

\subsubsection{Establish writing habits -- Thiết lập các thói quen viết lách}

\begin{quote}
	{\sf Hồng [28--?; writer]}: Thú thật. Tôi có 1 thói quen cực xấu: Tôi viết lách kiểu tốc ký vào 1 tờ giấy, bất cứ loại giấy gì, thường là giấy A4, nhưng cũng có thể là giấy súc (i.e., giấy vệ sinh). Nếu anh thắc mắc tại sao lại có cuộn giấy súc trên bàn viết lách của tôi thì tôi sẽ không giải thích. Có thể là tôi sợ đổ cafe dơ các xấp giấy mới tinh của tôi. Quên, lạc đề. Thói quen cực xấu khi viết lách của tôi là tôi hay quăng các bản thảo của tôi \& xé chúng. Nếu anh hỏi tại sao thì có lẽ 1 phần trong não, đúng hơn là 1 phần linh hồn của tôi không chấp nhận mong muốn trở thành nhà văn của tôi, chúng bắt tôi làm Toán. Thành ra có 1 sự giằng xé sâu sắc \& quyết liệt ở những lằn ranh giới về lựa chọn nghề nghiệp đó. Tôi không muốn anh phá hủy các bản nháp, bảo thảo chưa công bố của anh như tôi.
	
	{\sf Hồng [25; writer wannabe, literary retard]}: Thế tôi phải làm gì?
	
	{\sf Hồng [28--?; writer]}: Anh gõ ngay lại cái mớ bản nháp của anh vào máy tính, lưu lên mạng, Google Drive cũng khá tốt, nhưng các phần mềm quản lý phiên bản như {\tt git} là tốt nhất. Why? Anh sẽ phải viết đi, chỉnh lại nhiều lần. Đó là cái xương sống của nghề viết lách. Nên việc quản lý các phiên bản mang tính sống còn như việc phát triển các bó cơ để cái khung xương của anh có thể di chuyển.
	
	{\sf Hồng [25; writer wannabe, literary retard]}: Nhưng thế đéo mà mà nhà văn lại biết về mấy công cụ bên lập trình đó?
	
	{\sf Hồng [28--?; writer]}: À, chả có gì to tát. Tôi nhờ anh bạn {\sf Hồng [25--?; programmer, computer scientist wannabe]} giúp tôi. Tôi thích kiểu bút mực, giấy trắng truyền thống, nhưng tôi cũng không muốn mù tịt công nghệ mãi cho tới lúc chết được. Như vậy là sẽ thua với các cây bút trẻ đang lên.
\end{quote}
...
When a person decided to bully, but cannot physically bully, he{\tt/}she will intellectually bully.

-- Khi 1 người đã quyết định bắt nạt, nhưng không thể bắt nạt kiểu vật lý do con người lớn con, vạm vỡ hơn kẻ bắt nạt, thì hắn ta{\tt/}ả ta sẽ bắt nạt trí tuệ, để xoa dịu phần thiếu sót của bản thân gây ra bởi phức cảm tự ti, nhưng không dám thừa nhận do sự quá hèn nhát của bản thân.

\begin{quote}
	{\sf Bulliers [$\ge$ 26; mathematics PhDs; dumb]}: Anh{\tt/}chị chỉ lỡ bắt nạt em có 1 vài lần thôi mà. Tại sao em không thể ngừng chế giễu anh chị được chứ?
	
	{\sf Hồng [25; psychologist wannabe; smart enough]}: 1 lần? Hay suốt gần cả năm trời? Sao đó còn rượt theo cắn như 1 con Chihuahua hung dữ cắn không chịu nhả ra? Ý em là: If you can intellectually bully \& psychological manipulate me in order to take down my whole scientific career \& almost help me take my own life due to my critical depression, then why the fuck can you take a single joke about bullying, physical or intellectual or both? WTF? Who is the prey \& predators? Why can you exchange or reverse our roles in the big stage play without my permission like this? \&  Who the fuck is the weakest, fragilest person here? Weird as fuck.
		
	-- Cái đám bắt nạt kiểu đàn anh--đàn chị các anh chị có thể bắt nạt trí tuệ \& thao túng tâm lý nhằm tiêu diệt cả cái sự nghiệp làm Khoa học của em, thậm chí gần như giúp em lấy đi cái mạng của em nhờ vào cơn trầm cảm nặng, thì tại sao các anh chị không thể lấy 1 câu đùa về bắt nạt, vật lý hoặc trí tuệ hoặc cả 2, cơ chứ? Cái đéo gì vậy? Ủa rồi ai mới là con mồi, ai là kẻ săn mồi? Tại sao các anh chị lại có thể đổi vai 1 cách nhẹ nhàng trên cái sân khấu lớn này mà không có sự đồng ý của em chứ? Rồi ai mới là kẻ ủy mị, mong manh dễ vỡ ở đây đây? Thật là hết sức ngộ nghĩnh.
\end{quote}
...
\begin{enumerate}
	...
	\item \cite{Harper_unfuck}. {\sc Faith G. Harper}. {\it Unfuck Your Brain: Getting Over Anxiety, Depression, Anger, Freak-Outs, and Triggers with science (5-Minute Therapy)}.
	\begin{quotation}
...
\begin{goal}
	Quyển sách này là 1 quyển sách nhỏ nói về các quyển sách mà 2 tác giả cho là cần thiết đối với học sinh cấp 2 bắt đầu tuổi dạy thì, học sinh cấp 3 chuẩn bị bước vào trường Đại học hoặc trường đời hoặc cả 2, cho các sinh viên mới ra trường bắt đầu hoang mang kiếm việc làm, cũng như 1 tài liệu tham khảo dành cho quý phụ huynh, quý thầy cô, những người quan tâm đến giáo dục con cái, trẻ em, học sinh, sinh viên của mình. Quyển sách đóng vai trò như 1 cái Google Map, nhưng không phải về Địa Lý trong thế giới Vật Lý, mà trong thế giới của Tâm Trí để giúp các bạn trẻ không bị lạc đường, đặc biệt là các bạn thiếu sự quan tâm, tình thương của cha mẹ, \& các bạn mất cha hoặc mẹ hoặc cả 2.
\end{goal}
