...
\begin{enumerate}
	...
	-- Tôi nên làm nghề gì?
\end{enumerate}
Những lúc buồn chán \& thất vọng, bạn thường có những suy nghĩ như thế. Thay vì tự ngâm nga bài hát \href{https://www.youtube.com/watch?v=bqzDuRz_P7g}{\it Don't Know What To Do} của nhóm nhạc Hàn Quốc {\sc BlackPink} nổi tiếng.
...
We have used:
\begin{itemize}
	\item {\it Oxfords Dictionaries.} Including {\it Oxford Advanced Learner's Dictionary, Oxford Learner's Dictionary of Academic English}. \url{https://www.oxfordlearnersdictionaries.com/}.
	\item {\it Cambridge Dictionary} \url{https://dictionary.cambridge.org/}.
	\item {\it Merriam-Webster Dictionaries.} \url{https://www.merriam-webster.com/}.
\end{itemize}
...
\begin{itemize}
	\item ``Mỗi bài toán có 1 vai trò riêng của nó. Có bài được đề ra để kiểm tra khả năng tư duy, suy luận, có bài sẽ kiểm tra khả năng ghi nhớ công thức, 1 số bài là để kiểm tra khả năng tính toán \& cũng có bài thách thức người học để bứt phá bản thân. Vậy nên, để việc học Toán trở nên nhẹ nhàng hơn, thú vị hơn, hãy đặt mỗi bài toán vào đúng vị trí, vai trò của nó \& sự sáng tạo cũng nảy mầm từ đây. Bất đẳng thức (BĐT) cũng chỉ cần có vậy!'' -- \cite[Lời nói đầu, p. 3]{Anh_Quang_bdt_lem}
	\item Knuth
\end{itemize}
Giống như câu hỏi quen thuộc ``Con gà có trước hay quả trứng có trước'' mà dễ dàng trả lời bằng cách bắt bẻ ``trứng'' ở đây có thể là ``trứng khủng long'' hoặc ``trứng'' của 1 loài động vật được sinh ra trước loài gà, ta có câu hỏi ngu sau, thiên về Triết Học Trừu Tượng hơn là Sinh Học Tiến Hóa:

\begin{question}[Problem vs. Purpose -- Bài toán vs. Mục đích]
	Problem appears before Purpose or vice versa?
	
	-- Bài toán có trước hay Mục đích có trước?
\end{question}
...
-- Nhiều người hiểu lầm sức mạnh là sự tức giận và{\tt}hoặc sự hung hăng thống trị. Nhưng sức mạnh thực sự thực sự là {\it sự bình tĩnh dưới cơn bão}: {\it Lắng nghe \& quan sát để hiểu thay vì theo dõi \& phán đoán}.
...
\begin{goal}
	Rebuild a whole new scientific career.
	
	-- Xây dựng lại 1 sự nghiệp làm nghiên cứu Khoa Học mới hoàn toàn (cho bản thân).
\end{goal}
...
\begin{Rule}[Local vs. Global -- Cục bộ{\tt/}địa phương vs. Toàn cục{\tt/}tổng thể]
	...
	-- If you fail to do something locally, then do it globally. If you fail to do something globally, then do it locally. Change scale (microscale $\leftrightarrow$ macroscale) \& perspective, angles of introspection regularly, especially when being stuck.
\end{Rule}
