...
\begin{itemize}
	...
	Có 1 trường hợp đặc biệt là nếu người đó có hệ giá trị triết học độc lập với môi trường \& công việc hay người đó chỉ sống trong cái đầu của họ thì có thể ký hiệu gọn lại là $\phi(t)$ để bỏ các sự phụ thuộc vào công việc \& môi trường. Nhưng chỉ cho phép điều này với $\phi$, vì nếu tâm lý $\psi(t)$ của 1 người mà hoàn toàn độc lập với môi trường ${\rm env}(t)$ \& công việc $j(t)$ thì chắc người đó đã siêu thoát, hoặc nếu còn sống thì cũng đã đạt tới cảnh giới giác ngộ level niết bàn trong Phật giáo thì có lẽ nên cân nhắc việc phong thánh.
\end{itemize}
