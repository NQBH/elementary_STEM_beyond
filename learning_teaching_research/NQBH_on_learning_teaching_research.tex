...
\usepackage{amsmath,amssymb,amsthm,enumitem,fancyvrb,float,glossaries,graphicx,mathtools,multicol,musicography,soul,subfig,tikz}
\makeglossaries
...
\begin{quote}
	{\sf Phượng [40--50; Primary School teacher]}: 
...
-- Chúng tôi xin lỗi vì chúng tôi nên bắt đầu dự án này sớm hơn. Nhưng cuộc đấu tranh để trưởng thành về mặt tinh thần đủ lớn \& tàn khốc đến mức ngăn cản chúng ta làm được điều đó.
