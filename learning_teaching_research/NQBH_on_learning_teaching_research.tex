...
\begin{figure}[H]
	\centering
	\includegraphics[width = 15cm]{Berserk_behelit_color}
...
\begin{figure}[H]
	...
	\caption{{\sc Gojo Satoru} awakens before the fight with {\sc Toji Fushiguro} \href{https://www.imdb.com/title/tt12343534/}{\rm Jujutsu Kaisen} (2020--).}
\end{figure}
