...
\begin{itemize}
	\item \cite{Thoreau2014}. Henry David Thoreau. \textit{Walden or Life in the Woods} với bản dịch tiếng Việt \textit{Walden: Một Mình Sống Trong Rừng} \cite{Thoreau2023}.
	\item \cite{Krakauer1997}. Jon Krakauer. \textit{Into The Wild} với chuyển thể thành phim \href{https://www.imdb.com/title/tt0758758}{\it Into the Wild} (2007) của đạo diễn người Mỹ {\sc Sean Penn}.
\end{itemize}
...
\begin{quote}
	...
	{\sf Hồng [25; depressed mathematics PhD student]}: Tao không chắc 1 tấm bằng Tiến sĩ Toán ứng dụng có thể đo được hết khả năng của tao. Tao muốn được công nhận theo cách riêng của tao trên nhiều lĩnh vực, trong địa hạt Toán học \& cả bên ngoài địa hạt Toán học. Tao muốn bất cứ thứ gì tao quan tâm \& đụng tới đều trở thành 1 dạng nghệ thuật cả, như nhà Toán học người Anh nổi tiếng {\sc Godfrey Harold Hardy} trong quyển \textit{A Mathematician's Apology} \cite{Hardy1940,Hardy1992,Hardy2022} (tạm dịch: \textit{Lời Xin Lỗi Của 1 Nhà Toán Học}) hay kiểu \textit{dilettante}\footnote{\sf a person who does or studies something but is not serious about it and does not have much knowledge; a person with a general but superficial interest in any art or a branch of knowledge.} như {\sc Blaise Pascal} được mô tả trong quyển \textit{Pens\'ees} \cite{Pascal2003} (tạm dịch: \textit{Suy tư{\tt/}nghĩ}) vậy.
...
\end{quote}
-- hắn phán hệt như nhân vật chính không tên trong tiểu thuyết \textit{The Catcher In The Rye} \cite{Salinger_catcher_in_rye} của {\sc Jerome David Salinger} với bản dịch tiếng Việt \textit{Bắt Trẻ Đồng Xanh} \cite{Salinger_btdx}.
...
\begin{quote}
	...
	{\sf Nhân [26--?; Jeet Kune Do practitioner]}: Quyển \textit{Tao of Jeet Kune Do} \cite{Lee2011} (tạm dịch: \textit{Đạo của Tiệt Quyền Đạo}) của chính {\sc Bruce Lee} viết, tôi chưa nghiệm được tí nào.
...
\begin{quote}
	{\sf Hồng [27--?; psychologist]}: Để tôi tìm cách mô tả cấu trúc của 1 nhóm bắt nạt dẫn đầu \& thao túng bởi 1 kẻ thao túng cho anh hiểu.
	...
	{\sf Hồng [27--?; psychologist]}: Được chứ. Tưởng tượng 1 bàn cờ vua. Vua 1 bên là kẻ thao túng tâm lý (psychological manipulator in the role of predator). Vua bên còn lại sẽ là con mồi (prey) của kẻ thao túng tâm lý. Vị tiểu bạo chúa (the King), tức kẻ thao túng tâm lý sẽ chọn các người có nhân cách thuần tốt, chỉ biết cắm đầu học hoặc làm, dạng ngây thơ, làm con tốt thí, i.e., quân Tốt (Pawn) \& để che chắn khi bất cứ quân nào của đối phương tấn công hắn. Hắn sẽ phải tìm 1 quân Hậu (Queen). Đúng nghĩa \& chức năng của quân Hậu, đây phải là 1 người con gái có tính tình cộc cằn, thô lỗ, có thể ăn nói ngang ngược, càn quét ngang dọc, ăn xiêng nói xéo, để tấn công con mồi. Ngoài ra cần vài quân Xe (Rook), những người có chút đặc tính tốt \& biết ơn, dạng trung thành, nhưng chửi thề kiểu thô tục như cách đi ngang dọc của quân cờ này. Ngoài ra cần ít nhất 1 quân Ngựa (Knight, or Horse better in this context), 1 con ả dốt tới mức không biết mình dốt, cực kỳ dễ xoay theo chiều gió, ẹo ẹo trước mặt người khác, khiêu vũ cái điệu nhảy ``đàn ông nhạy cảm là đồ hèn, còn phụ nữ sẽ có quyền vì là phái yếu''. [...] Câu hỏi sẽ là: Liệu anh có thể thắng ván cờ này hay không nếu kẻ thao túng tâm lý được phép đi trước, tức là đã nhắm anh làm con mồi \& tấn công anh trước?
...
\begin{itemize}
	...
	\item Thường ưa dùng các từ dễ thương có vần ``um'', e.g., ``khum'' thay cho ``không'', nghe giống ``cum'', thường thích mượn các con vật dễ thương như ``cừu'' để che đậy bản chất là con sói gian manh, nham hiểm. Có thể phim \href{https://www.imdb.com/title/tt0102926}{\it The Silence of the Lambs} (1991) với tựa Việt \textit{Sự Yên Lặng Của Bầy Cừu} có liên quan đến đặc điểm hành vi này.
	\item Đôi khi ra lệnh kẻ khác giúp như cướp giật, bốc lột (dấu hiệu của demanding taker). Nếu người được nhắm đến có ý định từ chối hoặc ngó lơ, thì kẻ ái kỷ sẽ ra vẻ dễ thương, quyến rũ, e.g., vài tấm hình để lộ 1 phần cơ thể (nhưng không quá hở hang, mà nửa kín nửa hở) hoặc gương mặt gợi tình nhưng lạnh lùng, hấp dẫn kiểu bí ẩn, etc., để dụ con mồi vào cạm bẫy, lưới tình, những cuộc kết đôi se duyên lý tưởng, nhưng sẽ không bao giờ xảy ra hoặc nếu có xảy ra thì cũng sẽ không có tình cảm chân thành vì sự thiếu vắng 1 phần chức năng quan trọng trong cấu trúc não của kẻ ái kỷ liên quan đến sự cảm thông, lòng thấu cảm với người khác, \& đặc biệt là sự thiếu vắngv lương tâm (conscience) trong suy nghĩ, động cơ hành động, \& các hành vi biểu hiện ra bên ngoài.
\end{itemize}
...
\noindent\textbf{\textsf{Resources -- Tài nguyên.}}
\begin{itemize}
	\item \cite{Long2021}. Vũ Hoàng Long -- Người Kể Chuyện. \textit{Học Trường Chuyên -- Những Góc Nhìn Đa Chiều}.
\end{itemize}
...
\end{quote}
\textit{Tạm dịch}: Bất luận ai nói gì với bạn đi nữa, ngôn từ \& ý tưởng có thể thay đổi cả thế giới.
