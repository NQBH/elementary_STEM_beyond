...
\begin{itemize}
	...
	\end{quotation}
	CV: {\sc url}: \url{https://github.com/NQBH/publication/blob/master/CV/NQBH_CV.pdf}.
	
	Website: {\sc url}: \url{https://nqbh.github.io}.
	
	Trang web của {\it Some Topics in Elementary STEM \& Beyond}: {\sc url}: \url{https://nqbh.github.io/elementary_STEM}.
	
	Trang web của {\it Some Topics in Advanced STEM \& Beyond}: {\sc url}: \url{https://nqbh.github.io/advanced_STEM}.
	
	E-book library -- Thư viện sách điện tử: {\sc url}: \url{https://github.com/NQBH/reference}.
...
The last updated version of this short novel is stored at the following (permanent?) link:\\{\sc url}: {\sf\small\url{https://github.com/NQBH/elementary_STEM_beyond/blob/main/learning_teaching_research/NQBH_on_learning_teaching_research.pdf}}.

Bản cập nhật mới nhất của tiểu thuyết này được lưu trữ ở đường dẫn (cố định?):\\{\sc url}: {\sf\small\url{https://github.com/NQBH/elementary_STEM_beyond/blob/main/learning_teaching_research/NQBH_on_learning_teaching_research.pdf}}.
