...
\begin{enumerate}
	...
	-- Không có phiên bản cuối cùng của tiểu thuyết này, chỉ có bản cập nhập mới nhất mà thôi. Chúng tôi đối xử với tiểu thuyết này như là 1 phần mềm hơn là 1 quyển sách. Mà phần mềm thì sẽ có nhiều công đoạn bảo trì (maintenance), cập nhật (update), \& nâng cấp (upgrade). Cho nên nếu cứ giữ 1 phiên bản, thì sẽ bị tụt hậu so với thời gian.
\end{enumerate}
