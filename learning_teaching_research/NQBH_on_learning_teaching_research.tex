...
\section*{Disclaimers}
I, the narrator of this novel, claims that
\begin{itemize}
	\item Any character names mentioned in this piece of writing is purely imaginary.
	\item If there is any coincidence, so that a person in real life, denoted by $\mathbb{R}^3$, feels offended. I will apologize but take no responsibility.
\end{itemize}
