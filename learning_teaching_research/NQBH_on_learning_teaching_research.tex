...
\end{quote}
Bullying never ends if you do nothing to stop it. Bullying just gets better, \& better for the bulliers, i.e., it gets worse \& worse for the bullied. If worse is better, then you are definitely love BDSM (including Bondage, Discipline, Dominance, \& Submission, Sadomasochism, see \href{https://en.wikipedia.org/wiki/BDSM}{Wikipedia{\tt/}BDSM}).
...
You need to learn from book \& learn from life to have both book smart \& street smart. If you lack any 1 of these, you will get into a trouble.
