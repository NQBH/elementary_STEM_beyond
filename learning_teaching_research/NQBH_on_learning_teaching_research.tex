...
\begin{itemize}[leftmargin=*]
	...
	\item {\it Problem: Multivariate Polynomial -- Bài Tập: Đa Thức Nhiều Biến $\mathbb{R}[{\bf x}]$}.
	...
	\item {\it Problem \& Solution: Multivariate Polynomial -- Bài Tập \& Lời Giải: Đa Thức Nhiều Biến $\mathbb{R}[{\bf x}]$}.
