...
\subsubsection{Micro-envy \& micro-greedy -- Đố kỵ, tham lam từng ly từng tý}
...
\begin{quote}
	...
	{\sf Hồng [23; depressed mathematics Master 2 student]}: Hơn tôi 2--3 tuổi, bằng tuổi chị ruột tôi. Nhưng tính tình chả khác gì những đứa con nít to xác với những cái mồm độc ác cả.
	...
	{\sf Hồng [23; depressed mathematics Master 2 student]} \& {\sf Hồng [24; depressed mathematics PhD student]}: Thế chẳng lẽ chúng tôi phải bỏ Toán mới trưởng thành được à? Chúng tôi hoàn toàn có thể hủy diệt cái sự vô học đó của bọn họ. Họ không giỏi tiếng Anh, phát âm bập bẹ không nghe rõ được, kỹ năng máy tính thì cùi bắp, kiến thức Toán của tôi lủng phần Master 1 do phân môn Giải Tích (Mathematical Analysis) đòi hỏi kiến thức nền (background) nhiều hơn hẳn các phân môn khác như Đại Số \& Thống Kê, nhưng họ thì còn tệ hơn: họ lủng cả phần Bachelor; chưa kể học đến năm 2, năm 3 nghiên cứu sinh Tiến sĩ mà không sửa được mấy cái lỗi \LaTeX\ đơn giản, trong khi chúng tôi tự học trong 1 thời gian ngắn cũng làm được tất. Chúng tôi thừa sức để hủy diệt cái mồm vô học của bọn họ. Nhưng chả bao giờ chúng tôi chọn cách thô lỗ \& vô học đó cả. Đơn giản vì bản chất con người chúng tôi không phải thế. Nếu làm thế, chúng tôi sợ sẽ biến thành những người mà chúng tôi không ưa mất.
...
\noindent\fbox{\textbf{18}} Several people misunderstand strength as angriness and{\tt/}or dominant aggression. But the real strength actually is the {\it calmness under the storm} (Fig. \ref{fig6})$\ldots$ {\it Listening and observing to understand instead of watching and judging}$\ldots$
