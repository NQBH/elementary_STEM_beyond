...
\noindent\textbf{\textsf{Resources -- Tài nguyên.}}
\begin{itemize}
	\item \cite{Feibelman2011}. {\sc Peter J. Feibelman}. \textit{A PhD Is Not Enough!: A Guide to Survival in Science}.
...
\end{quote}
Hắn đeo tai nghe vào, mở gần max volume bài \textit{Beautiful} của rapper huyền thoại người Mỹ {\sc Eminem} để chìm sâu vào thế giới hướng nội riêng của hắn:
...
\textit{A decomposition of knowledge -- 1 phân hoạch của sự hiểu biết}:
\begin{itemize}
...
We, the authors, apologize to save this part for the last. Set the \textit{acknowledgment switch variable} is $\delta_{\rm ack}$. Đặt \textit{biến công tắc cảm ơn} là $\delta_{\rm ack}$.
