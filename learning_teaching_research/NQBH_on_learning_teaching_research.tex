...
\usepackage{amsmath,amssymb,amsthm,enumitem,fancyvrb,float,graphicx,mathtools,multicol,soul,subfig}
\allowdisplaybreaks
...
\begin{quotation}
	...
	{\sf Hồng [28--?; writer]}: Không việc gì. Kiến thức là tài sản chung mà. Việc gì phải ích kỷ, giấu làm của riêng. Tri thức được chia sẻ là 1 trong những chìa khóa dẫn tới hạnh phúc cá nhân của dân tri thức, như câu trích dẫn sau trong tiểu thuyết \textit{Into the Wild}:
	\begin{quotation}\it
...
\noindent\textbf{\textsf{Resources -- Tài nguyên.}}
\begin{itemize}
	\item \cite{Csikszentmihalyi2008}. {\sc Mihaly Csikszentmihalyi}. {\it Flow: The Psychology of Optimal Experience}  với bản dịch {\it Dòng Chảy: Tâm Lý Học Hiện Đại Trải Nghiệm Tối Ưu}.
	\item \cite{Csikszentmihalyi2013}. {\sc Mihaly Csikszentmihalyi}. {\it Creativity: Flow \& the Psychology of Discovery \& Invention}.
\end{itemize}
...
\begin{itemize}
	...
	\item Thích tỏa sáng, thích dành trọn spotlight. Tỏ ra cực kỳ khó chịu khi ai đó khác ``sáng chói'', thu hút sự chú ý của mọi người hơn hắn, cho nên hắn sẽ dùng mọi tiểu xảo để ngắt lời người đang dành được sự chú ý. Như 1 đứa con nít thích chiếm trọn sự chú ý của mọi người 1 cách toàn tâm toàn ý, \& sẽ kiếm chuyện, thậm chí đánh nhau với bất cứ đứa con nít nào dành sự chú ý mà đứa bé ích kỷ đấy thèm khát.
\end{itemize}
...
\begin{quote}
	{\sf Nhân [25; sex addicted naive boy]:} Nếu có thể miêu tả cảm giác của tui về kẻ ái kỷ, đặc biệt là nữ giới thì có lẽ sẽ là như thế này: 1 con ả ái kỷ sẽ tạo cho anh cảm giác là ả ta có cái \st{lồn} âm đạo khít, ngon, \& ngọt nước nhất mà anh từng được biết đến trong đời, \& anh sẽ phải làm nô dịch để ả ta sai này khiến nọ, cầm lên bỏ xuống, lúc quan tâm lúc thờ ơ như 1 món sex toy tự ảo tưởng về giá trị của bản thân, không phải theo nghĩa vật lý hay sinh học, mà theo nghĩa về tâm lý \& tinh thần, \& anh có thể bị tâm thần nếu không kiềm chế ham muốn của bản thân. Biết tại sao không? Con ả cực kỳ tài trong việc làm cho anh hứng tình rồi bỏ đi để anh thất vọng tột cùng. Sau 1 số lần lặp đủ nhiều \& mỗi vòng lặp đủ lâu thì bùm: Bất lực hoặc rối loạn cương dương như chơi anh ạ. Chả cần va chạm hay tiếp xúc bằng tay mà làm được đến mức kinh thế.
	...
	{\sf Nhân [25; sex addicted boy]:} [Zip] Sorry, my bad. A female narcissist will give you the impression, \& of course a illusion also, that she has the tightest, juiciest, \& most delicious that you have ever imagined in this world in your entire lifetime; \& you must become 1 of her unreal sex slave so that she can psychologically manipulate you easily, she can put a little bit of interest sometimes \& completely ignore most of the time. You are in the role of 1 of her sex toy but not in physical or biological sense, but in mental \& psychological sense.
\end{quote}

\begin{example}[Johnny Depp vs. Amber Heard]
	Vụ ly hôn của Tài tử điện ảnh {\sc Johnny Depp} \& cô vợ ái kỷ Amber Heard với các chẩn đoán về tâm thần nặng như Borderline Personality Disorder.
...
\begin{example}[Justin Bieber \& P. Diddy]
...
\begin{itemize}[leftmargin=*]
	\item Cheatsheet: Elementary Mathematics Grade 6. {\sc url}: {\footnotesize\url{https://github.com/NQBH/elementary_STEM_beyond/blob/main/elementary_mathematics/grade_6/cheatsheet/NQBH_elementary_mathematics_grade_6_cheatsheet.pdf}}.
...
\begin{itemize}[leftmargin=*]
	\item \textit{Problem: Proposition \& Set: Bài Tập: Mệnh Đề \& Tập Hợp}. {\sc url}: \url{https://github.com/NQBH/elementary_STEM_beyond/blob/main/elementary_mathematics/grade_10/proposition_set/problem/NQBH_proposition_set_problem.pdf}. TeX: \url{https://github.com/NQBH/elementary_STEM_beyond/blob/main/elementary_mathematics/grade_10/proposition_set/problem/NQBH_proposition_set_problem.tex}.
	\item \textit{Problem: Trigonometrical Identities in Triangles -- Bài Tập: Hệ Thức Lượng Trong Tam Giác}. {\sc url}: \url{https://github.com/NQBH/elementary_STEM_beyond/blob/main/elementary_mathematics/grade_10/trigonometry/problem/NQBH_trigonometry_problem.pdf}. TeX: \url{https://github.com/NQBH/elementary_STEM_beyond/blob/main/elementary_mathematics/grade_10/trigonometry/problem/NQBH_trigonometry_problem.tex}
	\item Problem: Vector -- Bài Tập: Vectơ. {\sc url}: \url{https://github.com/NQBH/elementary_STEM_beyond/blob/main/elementary_mathematics/grade_10/vector/problem/NQBH_vector_problem.pdf}. TeX: \url{https://github.com/NQBH/elementary_STEM_beyond/blob/main/elementary_mathematics/grade_10/vector/problem/NQBH_vector_problem.tex}.
\end{itemize}

\paragraph{Elementary Mathematics Grade 11 -- Toán sơ cấp lớp 11}

\begin{itemize}[leftmargin=*]
	\item \textit{Problem: Trigonometric Equation -- Bài Tập: Phương Trình Lượng Giác}. {\sc url}: \url{https://github.com/NQBH/elementary_STEM_beyond/blob/main/elementary_mathematics/grade_11/trigonometric_equation/problem/NQBH_trigonometric_equation_problem.pdf}.	
...
\textbf{\textsf{Resources -- Tài nguyên.}}
\begin{itemize}
	\item \cite{Andreescu_Dospinescu2010}. {\sf Titu Andreescu, Gabriel Dospinescu}. {\it Problems From The Book}. Tạm dịch: \textit{Các Vấn Đề Từ Quyển Sách}.
...
\noindent\textbf{\textsf{Resources -- Tài nguyên.}}
\begin{itemize}
	\item \cite{Polya2014}. George Polya. {\it How to Solve It}. Tạm dịch: \textit{Giải 1 Bài Toán Như Thế Nào?}
\end{itemize}
...
Tiểu thuyết này cùng các tài liệu liên quan được bán với giá $x$ VND{\tt/}euro, với $x\in[0,\infty)$ là 1 số thực không âm, i.e., muốn trả bao nhiêu cũng được, tùy vào đánh giá độ hay, độ hữu ích theo nhu cầu, nhận thức, \& thị hiếu của bạn đọc.
