...
\begin{quote}
	{\sf Hồng [23; mathematics Master 2 student; dyslexia\footnote{Chứng khó đọc, see, e.g., \href{https://en.wikipedia.org/wiki/Dyslexia}{Wikipedia{\tt/}dyslexia}.}]}: {\tt[thinking]}: Sao chị {\sf Phương} đọc nhiều sách mà chỉ nói chuyện vô duyên, thậm chí đôi khi nghe hơi ngu ngốc \& ít học thế? Chị đọc sách loại nào? Đọc kiểu gì? Đọc như thế nào?
